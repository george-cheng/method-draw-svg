    ...
    if (!("SVGPathSegList" in window)) {
        ...
        SVGPathSegList.prototype._parsePath = function (a) {
            ...
            b.prototype._parseNumber = function () {
                var l = 0, s = 0, c = 1, g = 0, d = 1, p = 1, w = this._currentIndex;
                this._skipOptionalSpaces();
                ...
                if (!(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9") && this._string.charAt(this._currentIndex) !=
                    ...
                    if (this._currentIndex != C) for (var v = this._currentIndex - 1, L = 1; v >= C;) {
                    ...
                    if (this._currentIndex != w && this._currentIndex + 1 < this._endIndex && (this._string.charAt(this._currentIndex) == "e" || this._string.charAt(this._currentIndex) == "E") && this._string.charAt(this._currentIndex + 1) != "x" && this._string.charAt(this._currentIndex + 1) != "m") {
                        ...
                        if (this._string.charAt(this._currentIndex) ==
                            "+") this._currentIndex++; else if (this._string.charAt(this._currentIndex) == "-") {
                            this._currentIndex++;
                            p = -1
                        }
            ...
            b.prototype._parseArcFlag = function () {
                if (!(this._currentIndex >= this._endIndex)) {
                    ...
                    if (l == "0") l = false; else if (l == "1") l = true; else return;
                    this._skipOptionalSpacesOrDelimiter();
                    return l
                }
            };
            b.prototype.parseSegment = function () {
                var l = this._string[this._currentIndex], s = this._pathSegTypeFromChar(l);
                ...
                switch (s) {
                    ...
                    case SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL:
                        l = {
                            x1: this._parseNumber(),
                            y1: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber()
                        };
...
function touchHandler(a) {
    var o = a.changedTouches, e = o[0], b = "";
    switch (a.type) {
        case "touchstart":
            b = "mousedown";
            break;
    ...
    function o(e) {
        if (typeof e.data === "string") {
            var b = e.handler, l = e.data.toLowerCase().split(" ");
            e.handler = function (s) {
                if (!(this !== s.target && (/textarea|select/i.test(s.target.nodeName) || s.target.type === "text"))) {
                    var c = s.type !== "keypress" && a.hotkeys.specialKeys[s.which],
                        g = String.fromCharCode(s.which).toLowerCase(), d = "", p = {};
                    ...
                    c = 0;
                    for (g = l.length; c < g; c++) if (p[l[c]]) return b.apply(this, arguments)
                }
            }
        }
    }
...
(function (a) {
    ...
    a.svgIcons = function (b, l) {
        function s(ka, Z) {
            ...
            if (l.no_img) setTimeout(function () {
                ...
                J = a(new Image).attr({src: da, width: 0, height: 0}).appendTo("body").load(function () {
                    c(true)
                }).error(function () {
                    c()
                })
        ...
        function c(ka, Z) {
            if (!H) {
                ...
                } else for (var oa = L.length, ma = 0; ma < oa; ma++) {
                    var na = L[ma], Ja = na.id;
                    if (Ja === "svg_eof") break;
                    a("#" + Ja);
                    na = na.getElementsByTagNameNS(p, "svg")[0];
                    var Fa = document.createElementNS(p, "svg");
                    Fa.setAttributeNS(p, "viewBox",
                        [0, 0, C, v].join(" "));
                    var Na = na.getAttribute("width"), Sa = na.getAttribute("height");
        ...
        function d(ka) {
            ...
            var Z = Array(Math.floor((ka.length + 2) / 3) * 4), da, pa, oa, ma, na, Ja, Fa = 0, Na = 0;
            do {
                da = ka.charCodeAt(Fa++);
                pa = ka.charCodeAt(Fa++);
                oa = ka.charCodeAt(Fa++);
                ...
                na = (pa & 15) << 2 | oa >> 6;
                Ja = oa & 63;
                if (isNaN(pa)) na = Ja = 64; else if (isNaN(oa)) Ja = 64;
        ...
        var p = "http://www.w3.org/2000/svg", w = "http://www.w3.org/1999/xlink", C = l.w ? l.w : 24,
            v = l.h ? l.h : 24, L, Q, J, H = false, U = false, R = 0, N = navigator.userAgent, ca = !!window.opera;
        ...
        if (l.svgz) {
            ...
            a.ajax({
                url: b, dataType: "string", success: function (ka) {
                    if (ka) {
        ...
        e = function (ka, Z) {
            ...
            var pa = ka[0].getElementsByTagName("*"), oa = pa.length;
            da.each(function (ma) {
                var na = this.id;
                a(Q).find("#" + na);
    ...
    a.resizeSvgIcons = function (b) {
        ...
        a.each(b, function (s, c) {
            var g = a.isArray(c), d = g ? c[0] : c, p = g ? c[1] : c;
...
(function () {
    function a(b, l, s) {
        ...
        if (e) for (var c in l) b.setAttribute(c, l[c]); else for (c in l) {
            var g = l[c], d = b[c];
            if (d && d.constructor === "SVGLength") d.baseVal.value = g; else b.setAttribute(c, g)
        }
        s && s.appendChild(b);
        return b
    }

    var o = {svg: "http://www.w3.org/2000/svg", xlink: "http://www.w3.org/1999/xlink"};
    ...
    jQuery.fn.jGraduate = function (b) {
        ...
        return this.each(function () {
            function s(ha, Y, ja, M, P) {
                var ba = P || a("stop", {"stop-color": Y, "stop-opacity": ja, offset: ha}, fa);
                if (P) {
                ...
                $(fa).find("stop").each(function () {
                    ...
                    if (+this.getAttribute("offset") > ha) {
                        if (!Y) {
                            var Wa = this.getAttribute("stop-color"), Za = this.getAttribute("stop-opacity");
            ...
            var w = $(this), C = $.extend(true, {}, jQuery.fn.jGraduateDefaults, b), v = w.attr("id"),
                L = "#" + w.attr("id") + " ";
            if (L) {
                var Q = function () {
                    switch (w.paint.type) {
                ...
                w.position();
                var H = null, U = $(window);
                if (w.paint.type == "none") w.paint = $.jGraduate.Paint({solidColor: "ffffff"});
                ...
                var R = $(L + "> .jGraduate_colPick"), N = $(L + "> .jGraduate_gradPick");
                ...
                var ca = 256, la = ca - 0, X = ca - 0, W, fa, ta, ia = {};
                $(".jGraduate_SliderBar").width(145);
                var ka = $("#" + v + "_jGraduate_GradContainer")[0],
                    Z = a("svg", {id: v + "_jgraduate_svg", width: ca, height: ca, xmlns: o.svg}, ka);
                W = W || w.paint.type;
                var da = fa = w.paint[W], pa = w.paint.alpha, oa = W === "solidColor";
                switch (W) {
                    case "solidColor":
                    case "linearGradient":
                        if (!oa) {
                        ...
                        a("radialGradient", {id: v + "_rg_jgraduate_grad"}, Z);
                    ...
                    case "radialGradient":
                        ...
                        a("linearGradient", {id: v + "_lg_jgraduate_grad", x1: 0, y1: 0, x2: 1, y2: 0}, Z)
                }
                if (oa) {
                ...
                var Fa = parseFloat(da.getAttribute("cx") || 0.5),
                    Na = parseFloat(da.getAttribute("cy") || 0.5), Sa = parseFloat(da.getAttribute("fx") || Fa),
                ...
                var Ka = $("<div/>").attr({
                        ...
                        title: "Begin Stop"
                    }).text(1).css({top: ma * ca, left: H * ca}).data("coord", "start").appendTo(ka),
                    ...
                    xa = $("<div/>").attr({
                        ...
                        title: "Center stop"
                    }).text("C").css({top: Na * ca, left: Fa * ca}).data("coord", "center").appendTo(ka),
                ...
                $.each(["x1", "y1", "x2", "y2", "cx", "cy", "fx", "fy"], function (ha, Y) {
                    var ja = fa.getAttribute(Y), M = isNaN(Y[1]);
                    ja || (ja = M ? "0.5" : Y === "x2" ? "1.0" : "0.0");
                    ia[Y] = $("#" + v + "_jGraduate_" +
                        Y).val(ja).change(function () {
                        if (isNaN(parseFloat(this.value)) || this.value < 0) this.value = 0; else if (this.value > 1) this.value = 1;
                        if (!(Y[0] === "f" && !eb)) if (M && W === "radialGradient" || !M && W === "linearGradient") fa.setAttribute(Y, this.value);
                        var P = M ? Y[0] === "c" ? xa : ra : Y[1] === "1" ? Ka : Ba,
                            ba = Y.indexOf("x") >= 0 ? "left" : "top";
                        P.css(ba, this.value * ca)
                    }).change()
                });
                var wa, kb, vb = $("#" + v + "_jGraduate_StopSlider"), cb, Ta, Va, Da = a("path", {
                    ...
                    Ta), ua, $a = 1, Ga = 1, Ra = 0, Ea = Fa, db = Na;
                Ta = a("svg", {width: "100%", height: 45}, vb[0]);
                ka = a("pattern", {width: 16, height: 16, patternUnits: "userSpaceOnUse", id: "jGraduate_trans"}, Ta);
                a("image", {
                    width: 16,
                    height: 16
                ...
                kb = a("g", {}, Ta);
                a("line", {x1: 10, y1: 15, x2: ca + 10, y2: 15, "stroke-width": 2, stroke: "#000"}, Ta);
                var lb = N.find(".jGraduate_spreadMethod").change(function () {
                    fa.setAttribute("spreadMethod", $(this).val())
                }), Ua = null, Xa = function (ha) {
                    var Y = ha.pageX - hb.left, ja = ha.pageY - hb.top;
                    Y = Y < 0 ? 0 : Y > ca ? ca : Y;
                    ja = ja < 0 ? 0 : ja > ca ? ca : ja;
                    Ua.css("left", Y).css("top", ja);
                    Y = Y / la;
                    ja = ja / X;
                    var M = Ua.data("coord"), P = fa;
                    switch (M) {
                        case "start":
                            ia.x1.val(Y);
                            ia.y1.val(ja);
                ...
                if (W === "radialGradient") if (eb) ra.show(); else {
                    ra.hide();
                    ia.fx.val("");
                    ia.fy.val("")
                }
                ...
                if (W === "radialGradient") {
                    ...
                    if (Z.numberOfItems === 2) {
                        ...
                        if (sa.type === 2 && Z.type === 3) {
                            sa = Z.matrix;
                            if (sa.a !== 1) N = Math.round(-(1 - sa.a) * 100); else if (sa.d !== 1) N = Math.round((1 - sa.d) * 100)
                        }
                ...
                N = {
                    ...
                    angle: {
                        handle: "#" + v + "_jGraduate_AngleArrows", input: "#" + v + "_jGraduate_AngleInput",
                        val: pa
                    }
                };
                $.each(N, function (ha, Y) {
                    ...
                    ja.mousedown(function (M) {
                        var P = ja.parent();
                        ab = {type: ha, elem: ja, input: $(Y.input), parent: P, offset: P.offset()};
                        U.mousemove(ob).mouseup(pb);
                        M.preventDefault()
                    });
                    $(Y.input).val(Y.val).change(function () {
                        var M = +this.value, P = 0, ba = W === "radialGradient";
                        switch (ha) {
                            case "radius":
                            ...
                            case "ellip":
                                ...
                                if (M > 99.5) M = 99.5;
                                if (M > 0) Ga = 1 - M / 100; else $a = -(M / 100) - 1;
                                P = 145 * ((M + 100) / 2) / 100;
                                ba && d();
                                break;
                            case "angle":
                        ...
                        if (P > 145) P = 145; else if (P < 0) P = 0;
                        ja.css({"margin-left": P - 5})
                    }).change()
                });
                var ob = function (ha) {
                ...
                $.extend($.fn.jPicker.defaults.window, {alphaSupport: true, effects: {type: "show", speed: 0}});
                R.jPicker({
...
jQuery && function () {
    ...
    $.extend($.fn, {
        contextMenu: function (e, b) {
            ...
            $(this).each(function () {
                var l = $(this), s = $(l).offset(), c = $("#" + e.menu);
                ...
                var g = function (d, p, w) {
                    ...
                    o.unbind("click");
                    c.css({top: v, left: C}).fadeIn(e.inSpeed);
                    ...
                    o.keypress(function (L) {
                        switch (L.keyCode) {
                            case 38:
                                ...
                                break;
                            case 40:
                                if (c.find("LI.hover").length == 0) c.find("LI:first").addClass("hover"); else {
                    ...
                    c.find("LI:not(.disabled) A").mouseup(function () {
                        ...
                        b && b($(this).attr("href").substr(1),
                            $(w), {x: C - s.left, y: v - s.top, docX: C, docY: v});
                        return false
                    });
                    setTimeout(function () {
                        o.click(function () {
            ...
            $(this).each(function () {
                if (e != undefined) for (var b = e.split(","), l = 0; l < b.length; l++) $(this).find('A[href="' + b[l] + '"]').parent().addClass("disabled")
            });
            return $(this)
            ...
            $(this).each(function () {
                if (e != undefined) for (var b = e.split(","), l = 0; l < b.length; l++) $(this).find('A[href="' + b[l] + '"]').parent().removeClass("disabled")
            });
            return $(this)
...
(function () {
    ...
    if (svgedit.browser.supportsSvg()) {
        var o = navigator.userAgent, e = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
            b = !!window.opera, l = o.indexOf("AppleWebKit") >= 0, s = o.indexOf("Gecko/") >= 0,
            c = o.indexOf("MSIE") >= 0, g = o.indexOf("Chrome/") >= 0, d = o.indexOf("Windows") >= 0,
            p = o.indexOf("Macintosh") >=
                0, w = "ontouchstart" in window, C = !!e.querySelector, v = !!document.evaluate, L = function () {
                ...
                var ca = new Blob(["<svg xmlns='http://www.w3.org/2000/svg'></svg>"], {type: "image/svg+xml;charset=utf-8"}),
                    la = new Image;
                la.onload = function () {
...
(function () {
    ...
    var a = document.createElementNS("http://www.w3.org/2000/svg", "svg"), o = {};
    svgedit.transformlist.SVGTransformList = function (e) {
        ...
        this._init = function () {
            ...
            if (b) for (var l = /\s*((scale|matrix|rotate|translate)\s*\(.*?\))\s*,?\s*/, s = true; s;) {
                s = b.match(l);
                b = b.replace(l, "");
                if (s && s[1]) {
                    var c = s[1].split(/\s*\(/), g = c[0];
                    c = c[1].match(/\s*(.*?)\s*\)/);
                    c[1] = c[1].replace(/(\d)-/g, "$1 -");
                    var d = c[1].split(/[, ]+/), p = "abcdef".split(""), w = a.createSVGMatrix();
                    $.each(d, function (L, Q) {
                        d[L] = parseFloat(Q);
                        if (g == "matrix") w[p[L]] = d[L]
                    });
                    c = a.createSVGTransform();
                    var C = "set" + g.charAt(0).toUpperCase() + g.slice(1), v = g == "matrix" ? [w] : d;
                    if (g == "scale" && v.length == 1) v.push(v[0]); else if (g == "translate" && v.length == 1) v.push(0); else if (g == "rotate" && v.length == 1) {
                        v.push(0);
                        v.push(0)
                    }
                    c[C].apply(c, v);
        ...
        this._removeFromOtherLists = function (b) {
            if (b) {
                var l =
                    false, s;
                for (s in o) {
                    for (var c = o[s], g = 0, d = c._xforms.length; g < d; ++g) if (c._xforms[g] == b) {
                        l = true;
                        c.removeItem(g);
                        break
                    }
        ...
        this.insertItemBefore = function (b, l) {
            var s = null;
            if (l >= 0) if (l < this.numberOfItems) {
                this._removeFromOtherLists(b);
    ...
    svgedit.transformlist.getTransformList = function (e) {
        if (svgedit.browser.supportsNativeTransformLists()) if (e.transform) return e.transform.baseVal;
        else if (e.gradientTransform) return e.gradientTransform.baseVal; else {
...
(function () {
    ...
    svgedit.math.transformPoint = function (o, e, b) {
        return {x: b.a * o + b.c * e + b.e, y: b.b * o + b.d * e + b.f}
    };
    ...
    svgedit.math.transformBox = function (o, e, b, l, s) {
        var c = {x: o, y: e}, g = {x: o + b, y: e};
        b = {x: o + b, y: e + l};
        o = {x: o, y: e + l};
        e = svgedit.math.transformPoint;
        c = e(c.x, c.y, s);
        var d = l = c.x, p = c.y, w = c.y;
        g = e(g.x, g.y, s);
        l = Math.min(l, g.x);
        d = Math.max(d, g.x);
        p = Math.min(p, g.y);
        ...
        p = Math.min(p, b.y);
        w = Math.max(w, b.y);
        return {tl: c, tr: g, bl: o, br: b, aabox: {x: l, y: p, width: d - l, height: w - p}}
    };
    ...
    svgedit.math.snapToAngle = function (o, e, b, l) {
        ...
        return {x: o + l * Math.cos(s), y: e + l * Math.sin(s), a: s}
    };
...
(function () {
    ...
    var a = ["x", "x1", "cx", "rx", "width"], o = ["y", "y1", "cy", "ry", "height"], e = $.merge(["r", "radius"], a);
    $.merge(e, o);
    var b, l = {px: 1};
    ...
    svgedit.units.convertAttrs = function (c) {
        var g = c.tagName, d = b.getBaseUnit();
        if (g = s[g]) for (var p = g.length, w = 0; w < p; w++) {
            var C = g[w], v = c.getAttribute(C);
    ...
    svgedit.units.convertToNum =
        function (c, g) {
            ...
            if (g.substr(-1) === "%") {
                var d = g.substr(0, g.length - 1) / 100, p = b.getWidth(), w = b.getHeight();
    ...
    svgedit.units.isValidUnit = function (c, g, d) {
        var p = false;
        if (e.indexOf(c) >= 0) if (isNaN(g)) {
            g = g.toLowerCase();
            $.each(l, function (v) {
                if (!p) if (RegExp("^-?[\\d\\.]+" + v + "$").test(g)) p = true
            })
        } else p = true; else if (c == "id") {
            c = false;
            try {
...
(function () {
    ...
    svgedit.utilities.encode64 = function (c) {
        ...
        var g = Array(Math.floor((c.length + 2) / 3) * 4), d, p, w, C, v, L, Q = 0, J = 0;
        do {
            d = c.charCodeAt(Q++);
            p = c.charCodeAt(Q++);
            w = c.charCodeAt(Q++);
            ...
            v = (p & 15) << 2 | w >> 6;
            L = w & 63;
            if (isNaN(p)) v = L = 64; else if (isNaN(w)) L = 64;
    ...
    svgedit.utilities.convertToXMLReferences = function (c) {
        for (var g = "", d = 0; d < c.length; d++) {
            ...
            if (p < 128) g += c[d]; else if (p > 127) g += "&#" + p + ";"
        }
        return g
    };
    ...
    svgedit.utilities.getUrlFromAttr = function (c) {
        if (c) if (c.indexOf('url("') === 0) return c.substring(5, c.indexOf('"', 6)); else if (c.indexOf("url('") === 0) return c.substring(5, c.indexOf("'", 6)); else if (c.indexOf("url(") === 0) return c.substring(4, c.indexOf(")"));
        return null
    };
    ...
    svgedit.utilities.getPathBBox = function (c) {
        var g = c.pathSegList, d = g.numberOfItems;
        c = [[], []];
        var p = g.getItem(0),
            w = [p.x, p.y];
        for (p = 0; p < d; p++) {
            ...
            if (typeof C.x != "undefined") {
                ...
                if (C.x1) {
                    for (var v = [C.x1, C.y1], L = [C.x2, C.y2], Q = [C.x, C.y], J = 0; J < 2; J++) {
                        ...
                        var H = 6 * w[J] - 12 * v[J] + 6 * L[J], U = -3 * w[J] + 9 * v[J] - 9 * L[J] + 3 * Q[J],
                            R = 3 * v[J] - 3 * w[J];
                        if (U == 0) {
                            if (H != 0) {
                                H = -R / H;
        ...
        return {x: g, y: p, width: d, height: c}
    };
    svgedit.utilities.getBBox = function (c) {
        ...
        switch (d) {
            ...
            case "path":
                ...
                } else c = svgedit.utilities.getPathBBox(g);
                break;
            case "g":
            case "a":
                c = a(g);
            ...
            default:
                if (d === "use") c = a(g, true);
                if (d === "use") c || (c = g.getBBox()); else if (~o.indexOf(d)) try {
                    c = g.getBBox()
                } catch (C) {
    ...
    svgedit.utilities.assignAttributes =
        function (c, g, d, p) {
            for (var w in g) if (d = w.substr(0, 4) === "xml:" ? "http://www.w3.org/XML/1998/namespace" : w.substr(0, 6) === "xlink:" ? "http://www.w3.org/1999/xlink" : null) c.setAttributeNS(d, w, g[w]); else p ? svgedit.units.setUnitAttr(c, w, g[w]) : c.setAttribute(w, g[w])
        };
    ...
    svgedit.sanitize.sanitizeSvg = function (l) {
        ...
        if (l.nodeType == 1) {
            ...
            if (l.ownerDocument && s) {
                var c = e[l.nodeName], g = b[l.nodeName];
                if (c !=
                    undefined) {
                    for (var d = [], p = l.attributes.length; p--;) {
                        var w = l.attributes.item(p), C = w.nodeName, v = w.localName, L = w.namespaceURI;
                    ...
                    if ((p = svgedit.utilities.getHref(l)) && ["filter", "linearGradient", "pattern", "radialGradient", "textPath", "use"].indexOf(l.nodeName) >= 0) if (p[0] != "#") {
                    ...
                    if (l.nodeName == "use" && !svgedit.utilities.getHref(l)) s.removeChild(l);
                        ...
                        $.each(["clip-path", "fill", "filter", "marker-end", "marker-mid", "marker-start", "mask", "stroke"], function (Q, J) {
                            ...
                            if (H) if ((H = svgedit.utilities.getUrlFromAttr(H)) && H[0] !== "#") {
                                l.setAttribute(J, "");
                                l.removeAttribute(J)
                            }
                        });
...
(function () {
    ...
    svgedit.history.ChangeElementCommand.prototype.apply = function (a) {
        ...
        for (e in this.newValues) {
            if (this.newValues[e]) if (e == "#text") this.elem.textContent = this.newValues[e]; else e == "#href" ? svgedit.utilities.setHref(this.elem, this.newValues[e]) : this.elem.setAttribute(e, this.newValues[e]); else if (e == "#text") this.elem.textContent = ""; else {
        ...
        if (!o) if (o = svgedit.utilities.getRotationAngle(this.elem)) {
            e = elem.getBBox();
    ...
    svgedit.history.ChangeElementCommand.prototype.unapply = function (a) {
        ...
        for (e in this.oldValues) {
            if (this.oldValues[e]) if (e ==
                "#text") this.elem.textContent = this.oldValues[e]; else e == "#href" ? svgedit.utilities.setHref(this.elem, this.oldValues[e]) : this.elem.setAttribute(e, this.oldValues[e]); else if (e == "#text") this.elem.textContent = ""; else this.elem.removeAttribute(e);
    ...
    svgedit.history.BatchCommand.prototype.elements = function () {
        for (var a = [], o = this.stack.length; o--;) for (var e = this.stack[o].elements(), b = e.length; b--;) a.indexOf(e[b]) == -1 && a.push(e[b]);
        return a
    };
    ...
    svgedit.history.UndoManager.prototype.beginUndoableChange = function (a, o) {
        ...
        this.undoableChangeStack[e] =
            {attrName: a, oldValues: l, elements: s}
    };
...
(function () {
    ...
    svgedit.select.Selector = function (b, l) {
        ...
        this.locked = true;
        this.selectorGroup = a.createSVGElement({element: "g", attr: {id: "selectorGroup" + this.id}});
    ...
    svgedit.select.Selector.prototype.resize = function () {
        var b = this.selectorRect, l = e, s = l.selectorGrips, c = this.selectedElement,
            g = c.getAttribute("stroke-width"), d = a.currentZoom(), p = 1 / d;
        ...
        if (w === "g" && !$.data(c, "gsvg")) if (w = a.getStrokedBBox(c.childNodes)) C = w;
        w = C.x;
        var v = C.y, L = C.width;
        C = C.height;
        p *= d;
        ...
        this.rotateCoords = {nw: [w, v], ne: [w + Q + 8, v], sw: [w, v + L + 8], se: [w + Q + 8, v + L + 8]};
    ...
    svgedit.select.SelectorManager.prototype.initGroup = function () {
        ...
        this.selectorParentGroup = a.createSVGElement({element: "g", attr: {id: "selectorParentGroup"}});
        this.selectorGripsGroup = a.createSVGElement({element: "g", attr: {display: "none"}});
        ...
        if (!$("#canvasBackground").length) {
            ...
            b = a.createSVGElement({
                element: "svg", attr: {
                    id: "canvasBackground", width: b[0], height: b[1], x: 0, y: 0,
                    overflow: svgedit.browser.isWebkit() ? "none" : "visible", style: "pointer-events:none"
                }
            });
            l = a.createSVGElement({element: "defs", attr: {id: "placeholder_defs"}});
            var s = a.createSVGElement({
                ...
                }), c = a.createSVGElement({element: "rect", attr: {x: 0, y: 0, width: 10, height: 10, fill: "#fff"}}),
                g = a.createSVGElement({element: "rect", attr: {x: 0, y: 0, width: 5, height: 5, fill: "#eee"}}),
    ...
    svgedit.select.SelectorManager.prototype.requestSelector = function (b) {
        ...
        for (var s = 0; s < l; ++s) if (this.selectors[s] && !this.selectors[s].locked) {
    ...
    svgedit.select.SelectorManager.prototype.releaseSelector =
        function (b) {
            if (b != null) for (var l = this.selectors.length, s = this.selectorMap[b.id], c = 0; c < l; ++c) if (this.selectors[c] && this.selectors[c] == s) {
...
(function () {
    ...
    var a = "a,circle,ellipse,foreignObject,g,image,line,path,polygon,polyline,rect,svg,text,tspan,use".split(","),
        o = {LET_DOCUMENT_DECIDE: 0, ALWAYS_RANDOMIZE: 1, NEVER_RANDOMIZE: 2}, e = o.LET_DOCUMENT_DECIDE;
    ...
    svgedit.draw.randomizeIds = function (b, l) {
        e = b == false ? o.NEVER_RANDOMIZE :
            o.ALWAYS_RANDOMIZE;
        if (e == o.ALWAYS_RANDOMIZE && !l.getNonce()) l.setNonce(Math.floor(Math.random() * 100001)); else e == o.NEVER_RANDOMIZE && l.getNonce() && l.clearNonce()
    };
    svgedit.draw.Drawing = function (b, l) {
        ...
        if (s && e != o.NEVER_RANDOMIZE) this.nonce_ = s; else e == o.ALWAYS_RANDOMIZE && this.setNonce(Math.floor(Math.random() * 100001))
    };
    ...
    svgedit.draw.Drawing.prototype.hasLayer = function (b) {
        for (var l = 0; l < this.getNumLayers(); l++) if (this.all_layers[l][0] == b) return true;
        return false
    };
    ...
    svgedit.draw.Drawing.prototype.getCurrentLayerName =
        function () {
            for (var b = 0; b < this.getNumLayers(); ++b) if (this.all_layers[b][1] == this.current_layer) return this.getLayerName(b);
            return ""
        };
    svgedit.draw.Drawing.prototype.setCurrentLayer = function (b) {
        for (var l = 0; l < this.getNumLayers(); ++l) if (b == this.getLayerName(l)) {
    ...
    svgedit.draw.Drawing.prototype.identifyLayers = function () {
        ...
        for (var b = this.svgElem_.childNodes.length, l = [], s = [], c = null, g = false, d = 0; d < b; ++d) {
            ...
            if (p && p.nodeType == 1) if (p.tagName == "g") {
                g = true;
                var w = $("title", p).text();
    ...
    svgedit.draw.Drawing.prototype.createLayer = function (b) {
        var l = this.svgElem_.ownerDocument, s = l.createElementNS("http://www.w3.org/2000/svg",
            "g");
    ...
    svgedit.draw.Drawing.prototype.getLayerVisibility = function (b) {
        for (var l = null, s = 0; s < this.getNumLayers(); ++s) if (this.getLayerName(s) == b) {
    ...
    svgedit.draw.Drawing.prototype.setLayerVisibility = function (b, l) {
        ...
        this.getNumLayers(); ++c) if (this.getLayerName(c) == b) {
    ...
    svgedit.draw.Drawing.prototype.getLayerOpacity = function (b) {
        for (var l = 0; l < this.getNumLayers(); ++l) if (this.getLayerName(l) == b) {
    ...
    svgedit.draw.Drawing.prototype.setLayerOpacity = function (b, l) {
        if (!(typeof l != "number" || l < 0 || l > 1)) for (var s =
            0; s < this.getNumLayers(); ++s) if (this.getLayerName(s) == b) {
...
(function () {
    ...
    svgedit.path.getGripPt = function (g, d) {
        var p = {x: d ? d.x : g.item.x, y: d ? d.y : g.item.y},
            w = g.path;
    ...
    svgedit.path.addPointGrip = function (g, d, p) {
        var w = svgedit.path.getGripContainer(), C = svgedit.utilities.getElem("pathpointgrip_" + g);
        if (!C) {
        ...
        if (d && p) svgedit.utilities.assignAttributes(C, {
            x: d - (svgedit.browser.isTouch() ?
                15 : 2.5), y: p - (svgedit.browser.isTouch() ? 15 : 2.5), display: "inline"
        });
        return C
    };
    ...
    svgedit.path.getCtrlLine = function (g) {
        ...
        svgedit.utilities.assignAttributes(d,
            {id: "ctrlLine_" + g, stroke: "#4F80FF", "stroke-width": 1, style: "pointer-events:none"});
        svgedit.path.getGripContainer().appendChild(d);
        return d
    };
    ...
    svgedit.path.getControlPoints = function (g) {
        var d = g.item, p = g.index;
        if (!d || !("x1" in d) || !("x2" in d)) return null;
        var w = {};
        svgedit.path.getGripContainer();
        for (var C = [svgedit.path.path.segs[p - 1].item, d], v = 1; v < 3; v++) {
            var L = p + "c" + v, Q = w["c" + v + "_line"] = svgedit.path.getCtrlLine(L),
                J = svgedit.path.getGripPt(g, {x: d["x" + v], y: d["y" + v]}),
                H = svgedit.path.getGripPt(g, {x: C[v - 1].x, y: C[v - 1].y});
            svgedit.utilities.assignAttributes(Q, {x1: J.x, y1: J.y, x2: H.x, y2: H.y, display: "inline"});
            w["c" + v + "_line"] = Q;
            pointGrip = w["c" + v] = svgedit.path.addCtrlGrip(L);
            svgedit.utilities.assignAttributes(pointGrip, {cx: J.x, cy: J.y, display: "inline"});
            w["c" +
            v] = pointGrip
        }
        return w
    ...
    svgedit.path.getSegSelector = function (g, d) {
        var p = g.index, w = svgedit.utilities.getElem("segline_" + p);
        if (!w) {
        ...
        if (d) {
            ...
            for (var v = 0; v < C.length; v += 2) {
                p = svgedit.path.getGripPt(g, {x: C[v], y: C[v + 1]});
                C[v] = p.x;
                C[v + 1] = p.y
            }
    ...
    svgedit.path.smoothControlPoints = this.smoothControlPoints = function (g, d, p) {
        ...
        if ((w != 0 || C != 0) && (v != 0 || L != 0)) {
            ...
            if (g < 0) g += 2 * Math.PI;
            if (d < 0) d += 2 * Math.PI;
            var Q = Math.abs(g - d), J = Math.abs(Math.PI - Q) / 2;
            if (g - d > 0) {
                g = Q < Math.PI ? g + J : g - J;
                d = Q < Math.PI ? d - J : d + J
            } else {
    ...
    svgedit.path.Segment.prototype.update = function (g) {
        if (this.ptgrip) {
            var d = svgedit.path.getGripPt(this), p = svgedit.browser.isTouch() ? 15 : 2.5;
    ...
    svgedit.path.Path.prototype.init = function () {
        ...
        var g = this.elem.pathSegList, d = g.numberOfItems;
        this.segs = [];
        this.selected_pts = [];
        this.first_seg = null;
        for (var p = 0; p < d; p++) {
        ...
        w = null;
        for (p = 0; p < d; p++) {
            var C = g[p], v = p + 1 >= d ? null : g[p + 1], L = p - 1 < 0 ? null : g[p - 1];
            if (C.type === 2) {
                if (L && L.type !== 1) {
                    v = g[w];
                    v.next = g[w + 1];
    ...
    svgedit.path.Path.prototype.eachSeg = function (g) {
        for (var d = this.segs.length, p = 0; p < d; p++) if (g.call(this.segs[p], p) === false) break
    };
    svgedit.path.Path.prototype.addSeg = function (g) {
        ...
        if (d.prev) {
            ...
            switch (d.item.pathSegType) {
                case 4:
                    var C = (d.item.x + p.item.x) / 2, v = (d.item.y + p.item.y) / 2;
                    w = this.elem.createSVGPathSegLinetoAbs(C, v);
                    break;
                case 6:
                    w = (p.item.x + d.item.x1) / 2;
                    var L = (d.item.x1 + d.item.x2) / 2, Q = (d.item.x2 + d.item.x) / 2, J = (w + L) / 2;
                    L = (L + Q) / 2;
                    C = (J + L) / 2;
                    var H = (p.item.y + d.item.y1) / 2, U = (d.item.y1 + d.item.y2) / 2;
    ...
    svgedit.path.Path.prototype.deleteSeg = function (g) {
        var d = this.segs[g], p = this.elem.pathSegList;
        d.show(false);
        var w = d.next;
        if (d.mate) {
    ...
    svgedit.path.Path.prototype.subpathIsClosed = function (g) {
        ...
        svgedit.path.path.eachSeg(function (p) {
            if (p <=
                g) return true;
            if (this.type === 2) return false; else if (this.type === 1) {
                d = true;
                return false
            }
        });
    ...
    svgedit.path.Path.prototype.setSegType = function (g) {
        ...
        for (var d = this.selected_pts.length, p; d--;) {
            ...
            if (C) {
                ...
                g -= 0;
                var v = w.item.x, L = w.item.y, Q = C.item.x;
                C = C.item.y;
                var J;
                switch (g) {
                    case 6:
    ...
    var c = function (g,
        ...
        r = Math.sqrt(dx * dx + dy * dy);
        theta = Math.atan2(dy, dx) - L;
        return {x: (r * Math.cos(theta) + C) / 1, y: (r * Math.sin(theta) + v) / 1}
    };
    svgedit.path.recalcRotatedPath = function () {
        var g = svgedit.path.path.elem, d = svgedit.utilities.getRotationAngle(g, true);
        if (d) {
            var p = svgedit.utilities.getBBox(g), w = svgedit.path.path.oldbbox, C = w.x + w.width / 2;
            w = w.y + w.height / 2;
            var v = p.x + p.width / 2;
            p = p.y + p.height /
                2;
            ...
            for (var Q = L.numberOfItems; Q;) {
                Q -= 1;
                var J = L.getItem(Q), H = J.pathSegType;
                if (H != 1) {
...
(function () {
    ...
    jQuery.fn.attr = function (o, e) {
        ...
        for (var l = 0; l < b; l++) {
            var s = this[l];
            if (s.namespaceURI === "http://www.w3.org/2000/svg") if (e !== undefined) s.setAttribute(o, e); else if ($.isArray(o)) {
                b = o.length;
                for (l = {}; b--;) {
                    var c = o[b], g = s.getAttribute(c);
                    if (g || g === "0") g = isNaN(g) ? g : g - 0;
                    l[c] = g
                }
                return l
            } else if (typeof o === "object") for (c in o) s.setAttribute(c, o[c]); else {
...
$.SvgCanvas = function (a, o) {
    function e(f, h) {
        for (var m = svgedit.utilities.getBBox(f), B = 0; B < 2; B++) {
            var A = B === 0 ? "fill" : "stroke", G = f.getAttribute(A);
            if (G && G.indexOf("url(") === 0) {
                G = P(G);
                if (G.tagName === "linearGradient") {
                    var D = G.getAttribute("x1") || 0, z = G.getAttribute("y1") || 0, F = G.getAttribute("x2") || 1,
    ...
    var b = "http://www.w3.org/2000/svg", l = {show_outside_canvas: true, selectNew: true, dimensions: [640, 480]};
    o && $.extend(l, o);
    var s = l.dimensions, c = this, g = a.ownerDocument,
    ...
    (c.clearSvgContentElement = function () {
        ...
        var f = g.createComment(" Created with Method Draw - http://github.com/duopixel/Method-Draw/ ");
        p.appendChild(f)
    })();
    var w = "svg_";
    c.setIdPrefix =
    ...
    $.extend(Q.text, {
        fill: "#000000", stroke_width: 0, font_size: 24,
        font_family: "Helvetica, Arial, sans-serif"
    });
    var J = Q.shape, H = Array(1), U = this.addSvgElementFromJson = function (f) {
            var h = svgedit.utilities.getElem(f.attr.id), m = C().getCurrentLayer();
            ...
            return h
        }, R = c.getTransformList = svgedit.transformlist.getTransformList, N = svgedit.math.transformPoint,
        ca = c.matrixMultiply = svgedit.math.matrixMultiply,
        la = c.hasMatrixTransform = svgedit.math.hasMatrixTransform,
        X = c.transformListToTransform = svgedit.math.transformListToTransform, W = svgedit.math.snapToAngle,
    ...
    var ia = c.getUrlFromAttr = svgedit.utilities.getUrlFromAttr,
        ka = c.getHref = svgedit.utilities.getHref, Z = c.setHref = svgedit.utilities.setHref,
        da = svgedit.utilities.getPathBBox;
    c.getBBox = svgedit.utilities.getBBox;
    var pa = c.getRotationAngle = svgedit.utilities.getRotationAngle, oa = c.getElem = svgedit.utilities.getElem,
        ma = c.assignAttributes = svgedit.utilities.assignAttributes,
        na = this.cleanupElement = svgedit.utilities.cleanupElement, Ja = svgedit.sanitize.getNSMap(),
        Fa = c.sanitizeSvg = svgedit.sanitize.sanitizeSvg, Na = svgedit.history.MoveElementCommand,
        Sa = svgedit.history.InsertElementCommand,
        Ia = svgedit.history.RemoveElementCommand, Ka = svgedit.history.ChangeElementCommand,
    ...
    c.undoMgr = new svgedit.history.UndoManager({
        handleHistoryEvent: function (f, h) {
            ...
            if (f == m.BEFORE_UNAPPLY || f == m.BEFORE_APPLY) c.clearSelection(); else if (f == m.AFTER_APPLY || f == m.AFTER_UNAPPLY) {
                var B = h.elements();
                c.pathActions.clear();
                M("changed", B);
                B = h.type();
                m = f == m.AFTER_APPLY;
                if (B == Na.type()) (m ? h.newParent : h.oldParent) == p && c.identifyLayers(); else if (B == Sa.type() ||
                    B == Ia.type()) {
                    h.parent == p && c.identifyLayers();
                    if (B == Sa.type()) m && Ta(h.elem); else m || Ta(h.elem);
    ...
    svgedit.utilities.snapToGrid = function (f) {
        var h = l.snappingStep, m = l.baseUnit;
        if (m !== "px") h *= svgedit.units.getTypeMap()[m];
        return f = Math.round(f / h) * h
    };
    var wa = svgedit.utilities.snapToGrid, kb = {
            exportNoBlur: "Blurred elements will appear as un-blurred",
            exportNoforeignObject: "foreignObject elements will not appear",
            exportNoDashArray: "Strokes will appear filled",
            exportNoText: "Text may not appear as expected"
        }, vb = ["clip-path", "fill", "filter", "marker-end", "marker-mid", "marker-start", "mask", "stroke"], cb = $.data,
        Ta = function (f) {
            var h = $(f).attr(vb), m;
            for (m in h) {
                var B = h[m];
        ...
        }, Va = {}, Da = l.imgPath + "logo.png", ua = [], $a = {round_digits: 5}, Ga = false, Ra =
            null, Ea = "select", db = "none", lb = {}, Ua = Q.text, Xa = J, wb = null, sa = null, hb = [], eb = {}, sb = {};
    c.clipBoard = [];
    var ib = this.runExtensions = function (f, h, m) {
        var B = false;
        if (m) B = [];
        $.each(eb, function (A, G) {
            if (f in G) if (m) B.push(G[f](h)); else B = G[f](h)
        });
        return B
    };
    this.addExtension = function (f, h) {
        if (f in eb) console.log('Cannot add extension "' + f + '", an extension by that name already exists"'); else {
    ...
    getStrokedBBox = this.getStrokedBBox =
        function (f) {
            ...
            var h = function (k) {
                try {
                    var n = svgedit.utilities.getBBox(k), q = svgedit.utilities.getRotationAngle(k);
                    if (q && q % 90 || svgedit.math.hasMatrixTransform(svgedit.transformlist.getTransformList(k))) {
                        q = false;
                        if (["ellipse", "path", "line", "polyline", "polygon"].indexOf(k.tagName) >= 0) n = q = c.convertToPath(k, true); else if (k.tagName == "rect") {
                            var u = k.getAttribute("rx"), E = k.getAttribute("ry");
                            if (u || E) n = q = c.convertToPath(k, true)
                        }
                        if (!q) {
                            var I = k.cloneNode(true), K = document.createElementNS(b,
                                "g"), O = k.parentNode;
                            O.appendChild(K);
                            K.appendChild(I);
            ...
            $.each(f, function () {
                if (!m) if (this.parentNode) m = h(this)
            });
            if (m == null) return null;
            var B = m.x + m.width, A = m.y + m.height, G = m.x, D = m.y, z = function (k) {
                var n = k.getAttribute("stroke-width"), q = 0;
    ...
    var pb = this.getVisibleElements = function (f) {
        ...
        if ($(f).data("gsvg")) $(h).data("gsvg", h.firstChild); else if ($(f).data("symbol")) {
            f = $(f).data("symbol");
    ...
    this.setRotationAngle = function (f, h) {
        ...
        var m = H[0];
        if (m) {
            var B = m.getAttribute("transform"), A = svgedit.utilities.getBBox(m), G = A.x + A.width / 2,
                D = A.y + A.height / 2;
            A = R(m);
    ...
    var Ca = this.recalculateAllSelectedDimensions = function () {
        ...
        Wa = function (f) {
            ...
            function (f, h, m) {
                var B = l.gridSnapping && f.parentNode.parentNode.localName === "svg", A = function () {
                    if (B) for (var q in h) h[q] = wa(h[q]);
                    ma(f, h, 1E3, true)
                };
                box = svgedit.utilities.getBBox(f);
                for (var G = 0; G < 2; G++) {
                    var D = G === 0 ? "fill" : "stroke", z = f.getAttribute(D);
                    if (z && z.indexOf("url(") === 0) if (m.a < 0 || m.d < 0) {
                        z = P(z).cloneNode(true);
                        if (m.a < 0) {
                            var F = z.getAttribute("x1"), k = z.getAttribute("x2");
                ...
                G = f.tagName;
                if (G === "g" || G === "text" || G === "use") if (m.a == 1 && m.b == 0 && m.c == 0 && m.d == 1 && (m.e != 0 || m.f != 0)) {
                    D = X(f).matrix;
                    D = ca(D.inverse(), m, D);
            ...
            f = P(f).firstChild;
            var B = R(f), A = d.createSVGTransform();
            A.setTranslate(h, m);
            B.appendItem(A);
            Qa(f)
            ...
            if (h && h.numberOfItems > 0) {
                for (var m = h.numberOfItems; m--;) {
                    var B = h.getItem(m);
                    if (B.type === 0) h.removeItem(m); else if (B.type === 1) svgedit.math.isIdentity(B.matrix) && h.removeItem(m); else B.type === 4 && B.angle === 0 && h.removeItem(m)
                }
            ...
            if (h) {
                ...
                for (var A = []; m--;) {
                    B = h.getItem(m);
                    if (B.type === 1) A.push([B.matrix, m]); else if (A.length) A = []
                }
                if (A.length === 2) {
            ...
            } else if (G) D = {x: $(G).attr("x") || 0, y: $(G).attr("y") || 0};
            if (z == null) {
                z = $.extend(true, {}, D);
            ...
            if (f.tagName == "g" && !G || f.tagName == "a") {
                ...
                var q = {x: A.x + A.width / 2, y: A.y + A.height / 2},
                ...
                if (E >= 3 && h.getItem(E - 2).type == 3 && h.getItem(E - 3).type == 2 && h.getItem(E - 1).type == 2) {
                    k = 3;
                    var K = h.getItem(E - 3).matrix, O = h.getItem(E - 2).matrix, V = h.getItem(E - 1).matrix;
                    F = f.childNodes;
                    for (n = F.length; n--;) {
                        var aa = F.item(n);
                        B = G = 0;
                        if (aa.nodeType ==
                            ...
                            if (S) {
                                ...
                                if (G || la(S)) {
                                    ...
                                    var qa = d.createSVGTransform(), va = d.createSVGTransform(),
                ...
                B = d.createSVGMatrix();
                if (G = pa(f)) {
                    q = {x: A.x + A.width / 2, y: A.y + A.height / 2};
                    u = N(A.x + A.width / 2, A.y + A.height / 2, X(h).matrix);
                    k = G * Math.PI / 180;
                ...
                k = 0;
                E = h.numberOfItems;
                if (!svgedit.browser.isWebkit()) if ((I = f.getAttribute("fill")) && I.indexOf("url(") === 0) {
                    I = P(I);
                    ea = "pattern";
            ...
            return m
        }, mb = null, ya = this.clearSelection =
            function (f) {
                if (H[0] != null) for (var h = H.length, m = 0; m < h; ++m) {
                    var B = H[m];
                    if (B == null) break;
            ...
            if (f.length != 0) {
                ...
                for (H.sort(function (G, D) {
                    if (G && D && G.compareDocumentPosition) return 3 - (D.compareDocumentPosition(G) & 6); else if (G == null) return 1
                }); H[0] == null;) H.shift(0)
            }
    ...
    this.removeFromSelection = function (f) {
        if (H[0] != null) if (f.length != 0) {
            var h = Array(H.length);
            j = 0;
            len = H.length;
            for (var m = 0; m < len; ++m) {
                var B = H[m];
                if (B) if (f.indexOf(B) == -1) {
                    h[j] = B;
                    j++
    ...
    var Bb = this.getMouseTarget = function (f) {
        ...
        if (["http://www.w3.org/1998/Math/MathML", "http://www.w3.org/1999/xhtml"].indexOf(f.namespaceURI) >= 0 && f.id != "svgcanvas") for (; f.nodeName != "foreignObject";) {
            f = f.parentNode;
            if (!f) return d
        }
    ...
    (function () {
        ...
        $(a).mousedown(function (z) {
            if (!c.spaceKey) {
                ...
                switch (Ea) {
                    case "select":
                        ...
                        if (q != d) {
                            ...
                            if (!F) for (F = 0; F < H.length; ++F) if (H[F] != null) {
                                var K = R(H[F]);
                            ...
                            B *= v;
                            A *= v;
                            ma(sa, {x: B, y: A, width: 0, height: 0, display: "inline"}, 100)
                        }
                        break;
                    case "zoom":
                        Ga = true;
                        if (sa == null) sa = ra.getRubberBandBox();
                        ma(sa, {x: u * v, y: u * v, width: 0, height: 0, display: "inline"}, 100);
                        break;
                    case "resize":
                        Ga = true;
                        h = n;
                    ...
                    case "rect":
                        ...
                        U({
                            element: "rect",
                            curStyles: true,
                            attr: {x: n, y: k, width: 0, height: 0, id: ja(), opacity: J.opacity / 2}
                        });
                        break;
                    case "line":
                        Ga = true;
                    ...
                    case "circle":
                        ...
                        U({
                            element: "circle",
                            curStyles: true, attr: {cx: n, cy: k, r: 0, id: ja(), opacity: J.opacity / 2}
                        });
                        break;
                    case "ellipse":
                        Ga = true;
                        U({
                            element: "ellipse",
                            curStyles: true,
                            attr: {cx: n, cy: k, rx: 0, ry: 0, id: ja(), opacity: J.opacity / 2}
                        });
                        break;
                    case "text":
                        Ga = true;
                ...
                K = ib("mouseDown", {event: z, start_x: h, start_y: m, selectedElements: H}, true);
            ...
            if (!(z.originalEvent.touches && z.originalEvent.touches.length > 1)) if (Ga) if (!(z.button ===
                1 || c.spaceKey)) {
                var F = H[0], k = N(z.pageX, z.pageY, mb), n = k.x * v;
                k = k.y * v;
                var q = oa(Y()), u = x = n / v, E = y = k / v;
                if (l.gridSnapping) {
                    x = wa(x);
                    y = wa(y)
                }
                ...
                switch (Ea) {
                    ...
                    case "multiselect":
                        ...
                        for (O = 0; O < E; ++O) {
                            I = K.indexOf(H[O]);
                            if (I == -1) q.push(H[O]); else K[I] = null
                        }
                        E = K.length;
                    ...
                    case "resize":
                        ...
                        var ga = ea = 0, T = S ? (S + I) / S : 1, qa = aa ? (aa + u) / aa : 1;
                        if (db.indexOf("n") >= 0) {
                            T = S ? (S -
                                I) / S : 1;
                            ga = S
                        ...
                        if (z.shiftKey) if (qa == 1) qa = T; else T = qa;
                        I.setScale(qa, T);
                    ...
                    case "image":
                        ...
                        ma(q, {width: u, height: K, x: E, y: O}, 1E3);
                        break;
                    case "circle":
                        u = $(q).attr(["cx", "cy"]);
                        K = u.cx;
                ...
                ib("mouseMove", {event: z, mouse_x: n, mouse_y: k, selected: F})
            }
        }).click(function (z) {
            z.preventDefault();
            return false
            ...
            if (z.button !== 2) {
                ...
                if (Ga) {
                    var k = N(z.pageX, z.pageY, mb), n = k.x * v;
                    k = k.y * v;
                    var q = n / v, u = k / v, E = oa(Y()), I = false;
                    Ga = false;
                    switch (Ea) {
                        case "resize":
                        case "multiselect":
                        ...
                        case "select":
                            if (H[0] != null) {
                                ...
                                if (n > 1 || n > 1) {
                                    ...
                                    n = z.target;
                                    if (H[0].nodeName === "path" && H[1] == null) Ha.select(H[0]); else z.shiftKey && F != n && c.removeFromSelection([n])
                                }
                                if (svgedit.browser.supportsNonScalingStroke()) if (z =
                                    H[0]) {
                    ...
                    n = ib("mouseUp", {event: z, mouse_x: n, mouse_y: k}, true);
                    ...
                    if (!I && E != null) {
                        ...
                        if (false.beginElement && E.getAttribute("opacity") !=
                            J.opacity) {
                            K = $(false).clone().attr({to: J.opacity, dur: z}).appendTo(E);
                            try {
                                K[0].beginElement()
                            } catch (O) {
                            }
                        ...
                        setTimeout(function () {
                            ...
                            na(E);
                            if (Ea === "path") Ha.toEditMode(E); else l.selectNew && rb([E], true);
                            xa(new Sa(E));
                            M("changed", [E])
                        }, z * 1E3)
                    }
        ...
        $(a).bind("mousewheel DOMMouseScroll", function (z) {
            if (z.shiftKey) {
                ...
                F = {
                    x: F.x,
                    y: F.y, width: 0, height: 0
                };
                if (z.wheelDelta) if (z.wheelDelta >= 120) F.factor = 2; else {
                    if (z.wheelDelta <= -120) F.factor = 0.5
                } else if (z.detail) if (z.detail > 0) F.factor = 0.5; else if (z.detail < 0) F.factor = 2;
                F.factor && M("zoomed", F)
            }
        })
    })();
    var Fb = function (f) {
        ...
        function f(S) {
            var ea = k.value === "";
            $(k).focus();
            if (!arguments.length) if (ea) S = 0; else {
            ...
            if (!n) {
                ...
                ma(n, {id: "text_cursor", stroke: "#333", "stroke-width": 1});
            ...
            ma(n, {x1: ea.x, y1: ea.y, x2: ga.x, y2: ga.y, visibility: "visible", display: "inline"});
        ...
        function h(S, ea, ga) {
            if (S === ea) f(ea); else {
                ...
                if (!q) {
                    ...
                    ma(q, {id: "text_selectblock", fill: "green", opacity: 0.5, style: "pointer-events:none"});
        ...
        function z(S) {
            if (aa && F) {
                ...
                ea = A(ea.x * v, ea.y * v);
                ea = m(ea.x, ea.y);
                var ga = F.textContent, T = ga.substr(0, ea).replace(/[a-z0-9]+$/i, "").length;
        ...
        return {
            select: function (S, ea, ga) {
            ...
            }, setCursor: f, toEditMode: function (S, ea) {
                rb([F], false);
                aa = false;
                Ea = "textedit";
                ...
                if (F) {
                    ...
                    var S = F.textContent.length, ea = F.getAttribute("transform");
                    I = svgedit.utilities.getBBox(F);
                    K = ea ? fa(F) : null;
                    E = Array(S);
                    k.focus();
                    $(F).unbind("dblclick", z).dblclick(z);
                    if (!S) var ga = {x: I.x + I.width / 2, width: 0};
                    for (ea = 0; ea < S; ea++) {
                        ...
                        E[ea] = {x: T.x, y: I.y, width: ga.x - T.x, height: I.height}
                    }
                    E.push({x: ga.x, width: 0});
        ...
        svgedit.path.Path.prototype.endChanges =
            function (D) {
                ...
                D = new Ka(this.elem, {d: this.last_d}, D);
                xa(D);
                M("changed", [this.elem])
            };
        ...
        return {
            mouseDown: function (D, z, F, k) {
                if (Ea === "path") {
                    ...
                    if (!k) {
                        ...
                        ma(k, {id: "path_stretch_line", stroke: "#22C", "stroke-width": "0.5", fill: "none"});
                    ...
                    if (A) {
                        ...
                        d_attr = "M" + F + "," + z + " ";
                        A = U({
                            element: "path", curStyles: true,
                            attr: {d: d_attr, id: ja(), opacity: J.opacity / 2}
                        });
                    ...
                    if (u.substr(0, 14) == "pathpointgrip_") {
                        ...
                        if (D.shiftKey) u.selected ? svgedit.path.path.removePtFromSelection(z) :
                            svgedit.path.path.addPtsToSelection(z); else {
                        ...
                        n = n == 2 ? {x: q.item.x, y: q.item.y} : {x: u.item.x, y: u.item.y};
                        q = {x: u.item["x" + E], y: u.item["y" + E]};
                        u = D(z, n);
                        D = D(q, n);
                    ...
                    if (!svgedit.path.path.dragging) {
                        ...
                        ma(sa, {
                            x: F *
                                v, y: k * v, width: 0, height: 0, display: "inline"
                        }, 100)
                    }
                }
                ...
                if (Ea === "path") {
                    if (A) {
                        var n = A.pathSegList, q = n.numberOfItems - 1, u = svgedit.path.addCtrlGrip("1c1"),
                            E = svgedit.path.addCtrlGrip("0c2");
                        if (m) {
                            var I = E.getAttribute("cx") / v || 0, K = E.getAttribute("cy") / v || 0;
                            u.setAttribute("cx", z);
                            u.setAttribute("cy", F);
                            ...
                            ma(E, {x1: z, y1: F, x2: D * v, y2: u * v, display: "inline"});
                            ma(K, {x1: I * v, y1: k * v, x2: D * v, y2: u * v, display: "inline"});
                            if (q === 0) B = [z, F]; else {
                                n = n.getItem(q - 1);
                                z = n.x;
                                F = n.y;
                            ...
                            if (q.pathSegType === 6) svgedit.path.replacePathSeg(6, 1, [z, F, (this.lastCtrlPoint[0] / v || q.x + (q.x - q.x2)) * v, (this.lastCtrlPoint[1] / v || q.y + (q.y - q.y2)) * v, n, u], k); else B ? svgedit.path.replacePathSeg(6, 1, [z, F, B[0], B[1], z, F], k) : svgedit.path.replacePathSeg(4, 1, [z, F], k)
                        }
                    }
                    ...
                    D = svgedit.path.getPointFromGrip({x: z, y: F}, svgedit.path.path);
                    q = D.x - n.x;
                    n = D.y - n.y;
                    ...
                    svgedit.path.path.eachSeg(function () {
                        if (this.next || this.prev) {
                            var aa = sa.getBBox(), S = svgedit.path.getGripPt(this);
                            aa = svgedit.math.rectsIntersect(aa, {x: S.x, y: S.y, width: 0, height: 0});
                            this.select(aa);
            ...
            mouseUp: function (D, z, F, k) {
                var n = oa("ctrlpointgrip_1c1"), q = oa("ctrlpointgrip_0c2");
                ...
                if (D) if (pa(D) != 0) {
                    var z = new Ba("Reorient path"),
                        F = {d: D.getAttribute("d"), transform: D.getAttribute("transform")};
                ...
                if (D.length ===
                    1) {
                    var z = svgedit.path.path.elem, F = z.pathSegList, k = D[0], n = null, q = null;
                    ...
                    if (n !== false) {
                        var u = z.createSVGPathSegLinetoAbs(q.x, q.y), E = z.createSVGPathSegClosePath();
                        ...
                        for (D = 0; D < F.numberOfItems; D++) {
                            var I = F.getItem(D);
                            if (I.pathSegType === 2) u = D; else if (D === k) F.removeItem(u); else if (I.pathSegType === 1 && k < D) {
                                E = D - 1;
                                F.removeItem(D);
                                break
                            }
                ...
                if (Ha.canDeleteNodes) {
                    ...
                    var F = function () {
                        var k = svgedit.path.path.elem.pathSegList, n = k.numberOfItems, q = function (I, K) {
                        ...
                        for (; n--;) {
                            ...
                            } else if (u.pathSegType === 2) if (n > 0) {
                ...
                var z = D.points, F = z.numberOfItems;
                if (F >= 4) {
                    var k = z.getItem(0), n = null;
                    D = [];
                    D.push(["M", k.x, ",", k.y, " C"].join(""));
                    for (var q = 1; q <= F - 4; q += 3) {
                        var u = z.getItem(q), E = z.getItem(q + 1), I = z.getItem(q + 2);
                        if (n) if ((k = svgedit.path.smoothControlPoints(n, u, k)) && k.length == 2) {
                    ...
                    D = D.join(" ");
                    D = U({element: "path", curStyles: true, attr: {id: Y(), d: D, fill: "none"}})
                }
                return D
                ...
                for (var F = D.pathSegList, k = F.numberOfItems, n = 0, q = 0, u = "", E = null, I = 0; I < k; ++I) {
                    var K = F.getItem(I), O = K.x || 0, V = K.y || 0, aa = K.x1 || 0, S = K.y1 || 0, ea = K.x2 || 0,
                        ga = K.y2 || 0, T = K.pathSegType, qa = Ma[T]["to" + (z ? "Lower" : "Upper") + "Case"](),
                    ...
                    switch (T) {
                        ...
                        case 11:
                            ...
                            va([[K.r1, K.r2]], [K.angle, K.largeArcFlag ? 1 : 0, K.sweepFlag ? 1 : 0], [O, V]);
                            break;
                        case 16:
                            O -= n;
                            ea -= n;
        ...
        for (var h = [], m = 0, B = ["fill", "stroke", "filter", "marker-start", "marker-mid",
            "marker-end"], A = B.length, G = p.getElementsByTagNameNS(b, "*"), D = G.length, z = 0; z < D; z++) {
            for (var F = G[z], k = 0; k < A; k++) if (F) {
    ...
    this.svgCanvasToString = function () {
        ...
        $(p).find("g:data(gsvg)").each(function () {
            for (var m = this.attributes, B = m.length, A = 0; A < B; A++) if (m[A].nodeName == "id" || m[A].nodeName == "style") B--;
            if (B <= 0) {
                m = this.firstChild;
                f.push(m);
                $(this).replaceWith(m)
    ...
    this.svgToString = function (f, h) {
        var m = [], B = svgedit.utilities.toXml,
            A = l.baseUnit, G = RegExp("^-?[\\d\\.]+" + A + "$");
        if (f) {
            na(f);
            var D = f.attributes, z, F, k = f.childNodes;
            ...
            if (f.id === "svgcontent") {
                ...
                for (A = ["width", "height", "xmlns", "x", "y", "viewBox", "id", "overflow"]; F--;) {
                    z = D.item(F);
                    var q = B(z.nodeValue);
                    if (z.nodeName.indexOf("xmlns:") !== 0) if (q != "" && A.indexOf(z.localName) == -1) if (!z.namespaceURI || Ja[z.namespaceURI]) {
                        m.push(" ");
                        m.push(z.nodeName);
                        m.push('="');
                        m.push(q);
                ...
                for (F = D.length - 1; F >= 0; F--) {
                    ...
                    if (!(u.indexOf(z.localName) >=
                        0)) if (q != "") if (q.indexOf("pointer-events") !== 0) if (!(z.localName === "class" && q.indexOf("se_") === 0)) {
                        m.push(" ");
    ...
    var Hb = this.uniquifyElems = function (f) {
        var h = {}, m = ["filter", "linearGradient", "pattern", "radialGradient", "symbol", "textPath", "use"];
        svgedit.utilities.walkTree(f, function (z) {
            if (z.nodeType == 1) {
                if (z.id) {
                    z.id in h || (h[z.id] = {elem: null, attrs: [], hrefs: []});
                    h[z.id].elem =
                        z
                }
                $.each(vb, function (k, n) {
                    ...
                    if (q) {
                        ...
                        if (u = u ? u.substr(1) : null) {
                            u in h || (h[u] = {elem: null, attrs: [], hrefs: []});
                            h[u].attrs.push(q)
                        }
                    }
                });
                var F = svgedit.utilities.getHref(z);
                if (F && m.indexOf(z.nodeName) >= 0) if (F = F.substr(1)) {
                    F in h || (h[F] = {elem: null, attrs: [], hrefs: []});
                    h[F].hrefs.push(z)
                }
            }
        });
        ...
        h.each(function () {
            if ($(this).attr("gradientUnits") === "userSpaceOnUse") {
                ...
                if (m.length) if (m = svgedit.utilities.getBBox(m[0])) if (this.tagName === "linearGradient") {
                    var B = $(this).attr(["x1", "y1", "x2", "y2"]), A = this.gradientTransform.baseVal;
                    ...
                    $(this).attr({
                        x1: (B.x1 - m.x) / m.width,
                        y1: (B.y1 - m.y) / m.height, x2: (B.x2 - m.x) / m.width, y2: (B.y2 - m.y) / m.height
                    });
    ...
    this.setSvgString = function (f) {
        try {
            ...
            this.prepareSvg(h);
            var m = new Ba("Change Source"), B = p.nextSibling, A = d.removeChild(p);
            ...
            var z = {id: "svgcontent", overflow: l.show_outside_canvas ? "visible" : "hidden"}, F = false;
            if (G.attr("viewBox")) {
                ...
                var V = G.attr(O);
                V || (V = "100%");
                if ((V + "").substr(-1) === "%") F = true; else z[O] = ta(O, V)
            });
            xb();
    ...
    this.getPaint = function (f, h, m) {
        ...
        if (f.indexOf("url(#") === 0) {
            ...
            B = {alpha: h};
            B[f.tagName] = f
        } else B = f.indexOf("#") === 0 ? {alpha: h, solidColor: f.substr(1)} : {alpha: h, solidColor: "none"};
        return new $.jGraduate.Paint(B)
    };
    this.importSvgString = function (f) {
        try {
            var h = svgedit.utilities.encode64(f.length + f).substr(0, 32), m = false;
            if (lb[h]) if ($(lb[h].symbol).parents("#svgroot").length) m = true;
            var B = new Ba("Import SVG");
            if (m) var A = lb[h].symbol, G = lb[h].xform; else {
                var D = svgedit.utilities.text2xml(f);
                this.prepareSvg(D);
                var z;
                z = g.adoptNode ? g.adoptNode(D.documentElement) : g.importNode(D.documentElement, true);
                Hb(z);
                var F = ta("width", z.getAttribute("width")), k = ta("height", z.getAttribute("height")), n =
                    z.getAttribute("viewBox"), q = n ? n.split(" ") : [0, 0, F, k];
    ...
    this.cloneLayer = function (f) {
        var h = new Ba("Duplicate Layer"), m = g.createElementNS(b, "g"), B = g.createElementNS(b, "title");
        B.textContent = f;
        m.appendChild(B);
        B = C().getCurrentLayer();
        $(B).after(m);
    ...
    this.deleteCurrentLayer = function () {
        var f = C().getCurrentLayer(), h = f.nextSibling,
            m = f.parentNode;
    ...
    this.renameCurrentLayer = function (f) {
        ...
        if (h.current_layer) {
            ...
            if (!c.setCurrentLayer(f)) {
                for (var B = new Ba("Rename Layer"), A = 0; A < h.getNumLayers(); ++A) if (h.all_layers[A][1] == m) break;
                ...
                for (A = 0; A < D; ++A) {
                    ...
                    if (z && z.tagName == "title") {
                        ...
                        z.textContent = f;
                        B.addSubCommand(new Ka(z, {"#text": G}));
                        xa(B);
                        M("changed", [m]);
                        return true
                    }
    ...
    this.setCurrentLayerPosition = function (f) {
        ...
        if (h.current_layer && f >= 0 && f < h.getNumLayers()) {
            for (var m = 0; m < h.getNumLayers(); ++m) if (h.all_layers[m][1] == h.current_layer) break;
            if (m == h.getNumLayers()) return false;
            if (m != f) {
                var B = null, A = h.current_layer.nextSibling;
                if (f > m) {
    ...
    this.setLayerVisibility = function (f, h) {
        var m = C(), B = m.getLayerVisibility(f), A = m.setLayerVisibility(f, h);
        if (A) xa(new Ka(A, {display: B ? "inline" : "none"}, "Layer Visibility")); else return false;
    ...
    this.moveSelectedToLayer = function (f) {
        for (var h = null, m = C(), B = 0; B < m.getNumLayers(); ++B) if (m.getLayerName(B) == f) {
            h = m.all_layers[B][1];
            break
        }
        if (!h) return false;
        ...
        for (B = m.length; B--;) {
            var A = m[B];
            if (A) {
                var G = A.nextSibling, D = A.parentNode;
                h.appendChild(A);
    ...
    this.mergeLayer = function (f) {
        var h = new Ba("Merge Layer"), m = C(), B = $(m.current_layer).prev()[0];
        if (B) {
    ...
    this.mergeAllLayers = function () {
        var f = new Ba("Merge all Layers"), h = C();
    ...
    var zb = this.getResolution = function () {
        var f = p.getAttribute("width") / v, h = p.getAttribute("height") / v;
    ...
    this.getTitle = function (f) {
        if (f = f || H[0]) {
            ...
            f = f.childNodes;
            for (var h = 0; h < f.length; h++) if (f[h].nodeName == "title") return f[h].textContent;
            return ""
        }
    };
    this.setGroupTitle = function (f) {
        var h = H[0];
        h = $(h).data("gsvg") || h;
        var m = $(h).children("title"), B = new Ba("Set Label");
        if (f.length) if (m.length) {
            m = m[0];
            B.addSubCommand(new Ka(m, {"#text": m.textContent}));
            m.textContent = f
        } else {
    ...
    this.setDocumentTitle = function (f) {
        for (var h = p.childNodes,
                 m = false, B = "", A = new Ba("Change Image Title"), G = 0; G < h.length; G++) if (h[G].nodeName == "title") {
            m = h[G];
            B = m.textContent;
            break
        }
        ...
        if (f.length) m.textContent = f; else m.parentNode.removeChild(m);
        A.addSubCommand(new Ka(m, {"#text": B}));
        xa(A)
    };
    ...
    this.setResolution = function (f, h) {
        ...
        if (f != B || h != m) {
            ...
            this.contentW = f;
            this.contentH = h;
            A.addSubCommand(new Ka(p, {width: B, height: m}));
            p.setAttribute("viewBox",
                [0, 0, f / v, h / v].join(" "));
            A.addSubCommand(new Ka(p, {viewBox: ["0 0", B, m].join(" ")}));
            xa(A);
    ...
    this.setColor = function (f, h, m) {
        J[f] = h;
        Xa[f + "_paint"] = {type: "solidColor"};
        for (var B = [], A = H.length; A--;) {
            var G = H[A];
            if (G) if (G.tagName == "g") svgedit.utilities.walkTree(G,
                function (D) {
                    D.nodeName != "g" && B.push(D)
                }); else if (f == "fill") G.tagName != "polyline" && G.tagName != "line" && B.push(G); else B.push(G)
        }
        if (B.length > 0) if (m) Ab(f, h, B); else {
            Ya(f, h, B);
            M("changed", B)
        }
    };
    var gb = function () {
        ...
        for (var m = h.length, B = ["r", "cx", "cy", "fx", "fy"]; m--;) {
            ...
            if (f.tagName == "linearGradient") {
                ...
                var G = $(f).attr(B), D = $(A).attr(B), z = false;
                $.each(B, function (E, I) {
                    if (G[I] != D[I]) z = true
                });
                if (z) continue
            }
            var F = f.getElementsByTagNameNS(b, "stop"), k = A.getElementsByTagNameNS(b, "stop");
    ...
    this.setPaint = function (f, h) {
        ...
        switch (m.type) {
            case "solidColor":
                if (m.solidColor != "none" && m.solidColor != "#none") this.setColor(f, "#" + m.solidColor); else {
    ...
    this.setStrokeWidth =
        function (f) {
            if (f == 0 && ["line", "path"].indexOf(Ea) >= 0) c.setStrokeWidth(1); else {
                Xa.stroke_width = f;
    ...
    this.getBlur = function (f) {
        var h = 0;
        if (f) if (f.getAttribute("filter")) if (f = oa(f.id + "_blur")) h = f.firstChild.getAttribute("stdDeviation");
        return h
    };
    (function () {
        function f() {
        ...
        c.setBlurOffsets = function (A, G) {
            if (G > 3) ma(A, {
                x: "-50%", y: "-50%", width: "200%",
                height: "200%"
            }, 100); else if (!svgedit.browser.isWebkit()) {
                A.removeAttribute("x");
                A.removeAttribute("y");
        ...
        c.setBlur = function (A, G) {
            if (h) f(); else {
                ...
                if (m) {
                    ...
                    var k = U({element: "feGaussianBlur", attr: {"in": "SourceGraphic", stdDeviation: A}});
                    m = U({element: "filter", attr: {id: z + "_blur"}});
                    m.appendChild(k);
                    gb().appendChild(m);
                    F.addSubCommand(new Sa(m))
                }
                k = {filter: D.getAttribute("filter")};
                if (A ===
                    0) {
    ...
    this.setImageURL = function (f) {
        ...
        if (h) {
            ...
            m = !m.width ||
                !m.height;
            var B = ka(h);
            if (B !== f) m = true; else if (!m) return;
            var A = new Ba("Change Image URL");
            Z(h, f);
            A.addSubCommand(new Ka(h, {"#href": B}));
    ...
    this.setLinkURL = function (f) {
        ...
        if (h) {
            ...
            if (m !== f) {
                ...
                Z(h, f);
                B.addSubCommand(new Ka(h, {"#href": m}));
                xa(B)
            }
        }
    };
    ...
    this.convertToPath = function (f, h) {
        if (f == null) $.each(H, function (aa, S) {
            ...
            var A = U({element: "path", attr: B}), G = f.getAttribute("transform");
            G && A.setAttribute("transform", G);
            var D = f.id, z = f.parentNode;
            ...
            switch (f.tagName) {
                ...
                case "circle":
                    var q =
                        $(f).attr(["rx", "ry", "cx", "cy"]), u = q.cx, E = q.cy, I = q.rx;
                    q = q.ry;
                    if (f.tagName == "circle") I = q = $(f).attr("r");
                    k([["M", [u - I, E]], ["C", [u - I, E - q / n, u - I / n, E - q, u, E - q]], ["C", [u + I / n, E - q, u + I, E - q / n, u + I, E]], ["C", [u + I, E + q / n, u + I / n, E + q, u, E + q]], ["C", [u - I / n, E + q, u - I, E + q / n, u - I, E]], ["Z", []]]);
                    break;
                case "path":
                    F = f.getAttribute("d");
                    break;
                ...
                case "rect":
                    ...
                    K = K.height;
                    n = 4 - n;
                    if (!I && !q) k([["M", [u, E]], ["L", [u + O, E]], ["L", [u + O, E + K]], ["L", [u, E + K]], ["L", [u, E]], ["Z", []]]); else {
                        q || (q = I);
                        k([["M", [u, E + q]], ["C", [u, E + q / n, u + I / n, E, u + I, E]], ["L", [u + O - I, E]], ["C", [u + O - I / n, E, u + O, E + q / n, u + O, E + q]], ["L", [u + O, E + K - q]], ["C", [u + O, E + K - q / n, u + O - I / n, E + K, u + O - I, E + K]], ["L", [u + I, E + K]], ["C", [u + I / n, E + K, u, E + K - q / n, u, E + K - q]], ["L", [u, E + q]], ["Z", []]])
                    }
                    break;
                default:
            ...
            if (G != null) {
                ...
                if ((f === "x" || f === "y") && A.indexOf(G.tagName) >= 0) {
                    ...
                    if (D !== String(h)) {
                        ...
                        D = pa(G);
                        if (D != 0 && f != "transform") for (var z =
                            R(G), F = z.numberOfItems; F--;) if (z.getItem(F).type == 4) {
                            z.removeItem(F);
    ...
    var Db = this.pushGroupProperties = function (f, h) {
        var m = f.childNodes, B = m.length, A = f.getAttribute("transform"), G = R(f), D = X(G).matrix,
            z = new Ba("Push group properties"), F = 0, k = pa(f), n = $(f).attr(["filter", "opacity"]), q, u;
        for (F = 0; F < B; F++) {
            var E = m[F];
            if (E.nodeType === 1) {
                ...
                if (n.filter) {
                    ...
                    u || (u = this.getBlur(f));
                    if (I) I = u - 0 + (I - 0); else if (I ===
                        0) I = u;
                    if (K) q = P(E.getAttribute("filter")); else if (q) {
                        q = ha(q);
                        gb().appendChild(q)
                    } else q = P(n.filter);
                ...
                if (I) if (E.tagName !== "defs") if (G.numberOfItems) {
                    if (k && G.numberOfItems == 1) {
                        var O = G.getItem(0).matrix, V = d.createSVGMatrix();
                        if (K = pa(E)) V = I.getItem(0).matrix;
                        var aa = svgedit.utilities.getBBox(E),
                            S = X(I).matrix, ea = N(aa.x + aa.width / 2, aa.y + aa.height / 2, S);
                        aa = k + K;
    ...
    this.ungroupSelectedElement = function () {
        var f = H[0];
        if ($(f).data("gsvg") || $(f).data("symbol")) Lb(f); else if (f.tagName === "use") {
            ...
            if (f.tagName === "g" || f.tagName === "a") {
                ...
                for (var B = f.nextSibling, A = Array(f.childNodes.length), G = 0; f.firstChild;) {
                    var D = f.firstChild, z = D.nextSibling, F = D.parentNode;
                    if (D.tagName === "title") {
    ...
    this.moveToTopSelectedElement = function () {
        var f = H.filter(Boolean).reverse(), h = new Ba("Move to top");
        f.forEach(function (m) {
            m =
                m;
            var B = m.parentNode, A = m.nextSibling;
    ...
    this.moveToBottomSelectedElement = function () {
        ...
        f.forEach(function (m) {
            m = m;
            var B = m.parentNode, A = m.nextSibling, G = m.parentNode.firstChild;
    ...
    this.moveSelectedElements = function (f, h, m) {
        ...
        for (var B = new Ba("position"), A = H.length; A--;) {
            var G = H[A];
            if (G != null) {
                var D = d.createSVGTransform(), z = R(G);
    ...
    this.cloneSelectedElements = function (f, h, m) {
        ...
        for (clones = []; G--;) {
            D = A[G];
            var z = ha(A[G]), F = L || C().getCurrentLayer();
            if (m) {
                tlist = R(z);
                tlist.removeItem(m);
                Qa(z);
    ...
    this.alignSelectedElements = function (f, h) {
        var m = [], B = Number.MAX_VALUE, A = Number.MIN_VALUE, G = Number.MAX_VALUE,
            D = Number.MIN_VALUE, z = Number.MIN_VALUE, F = Number.MIN_VALUE, k = H.length;
        if (k) {
            for (var n = 0; n < k; ++n) {
                if (H[n] == null) break;
    ...
    this.updateCanvas = function (f, h) {
        ...
        var m = $("#canvasBackground")[0], B = p.getAttribute("x"), A = p.getAttribute("y"),
            G = f / 2 - this.contentW * v / 2, D = h / 2 - this.contentH * v / 2;
        ma(p, {
        ...
        ma(m, {width: p.getAttribute("width"), height: p.getAttribute("height"), x: G, y: D});
        (m = oa("background_image")) && ma(m, {width: "100%", height: "100%"});
        ra.selectorParentGroup.setAttribute("transform", "translate(" + G + "," + D + ")");
        return {x: G, y: D, old_x: B, old_y: A, d_x: G - B, d_y: D - A}
    };
    this.setBackground = function (f, h) {
        var m = oa("canvasBackground"), B = $(m).find("rect")[0], A = oa("background_image");
        B.setAttribute("fill", f);
        if (h) {
            if (!A) {
                A = g.createElementNS(b, "image");
                ma(A, {
                    id: "background_image", width: "100%", height: "100%", preserveAspectRatio: "xMinYMin",
                    style: "pointer-events:none"
                })
            }
            Z(A, h);
    ...
    this.cycleElement = function (f) {
        var h = H[0], m = false, B = pb(L || C().getCurrentLayer());
        if (B.length) {
            if (h == null) {
                f = f ? B.length - 1 : 0;
                m = B[f]
            } else for (var A = B.length; A--;) if (B[A] == h) {
                f = f ? A - 1 : A + 1;
                if (f >= B.length) f = 0; else if (f < 0) f = B.length - 1;
                m = B[f];
                break
            }
            rb([m], true);
...
(function () {
    ...
    if (!window.methodDraw) window.methodDraw = function (a) {
        ...
        uiStrings = b.uiStrings = {
            common: {
                ok: "OK", cancel: "Cancel", key_up: "Up",
                key_down: "Down", key_backspace: "Backspace", key_del: "Del"
        ...
        b.init = function () {
            ...
            a.svgIcons(curConfig.imgPath + "svg_edit_icons.svg", {
                w: 27, h: 27,
                id_match: false, no_img: true, fallback_path: curConfig.imgPath, fallback: {
                    logo: "logo.png",
                    select: "select.png",
                    ...
                    a(".tools_flyout").each(function () {
                        var n = a("#" + this.id + "_show"), q = n.attr("data-curopt");
            ...
            a("#rulers").on("dblclick", function (k) {
                a("#base_unit_container").css({top: k.pageY - 10, left: k.pageX - 50, display: "block"})
            });
            ...
            b.show_save_warning = false;
            b.paintBox = {fill: null, stroke: null, canvas: null};
            d = navigator.platform.indexOf("Mac") >= 0;
            var p = navigator.userAgent.indexOf("AppleWebKit") >= 0, w = d ? "meta+" : "ctrl+", C = e.pathActions,
                v = e.undoMgr, L = svgedit.utilities, Q = curConfig.imgPath + "placeholder.svg", J = a("#workarea"),
                H = a("#cmenu_canvas"), U = null, R = 1, N = "toolbars", ca = "";
            d || a(".shortcut").each(function () {
                var k = a(this).text();
                a(this).text(k.split("\u2318").join("Ctrl+"))
            });
            (function () {
                a("#dialog_container").draggable({cancel: "#dialog_content, #dialog_buttons *", containment: "window"});
                var k = a("#dialog_box"), n = a("#dialog_buttons"), q = function (u, E, I, K) {
            ...
            var ka = function () {
                ...
                a.each(k, function (n, q) {
                    var u = a(n).children(), E = n + "_show", I = a(E), K = false;
                    ...
                    if (K) I.attr("data-curopt", q[K].sel); else I.attr("data-curopt") ||
                    I.attr("data-curopt", q[0].sel);
                    var O, V = a(E).position();
                    a(n).css({left: V.left + 34, top: V.top + 77});
                    I.mousedown(function (aa) {
                        ...
                        var S = a(n), ea = V.left + 34, ga = S.width() * -1, T = S.data("shown_popop") ? 200 : 0;
                        O = setTimeout(function () {
                            I.data("isLibrary") ? S.css("left", ea).show() : S.css("left", ga).show().animate({left: ea}, 50);
                        ...
                        if (I.data("isLibrary") && a(E.replace("_show", "")).is(":visible")) ra(E, true); else ra(E) && aa in Z && Z[aa]()
                    })
                });
                ma()
            }, pa = function (k, n) {
                return a("<div>", {"class": "tools_flyout", id: k}).appendTo("#svg_editor").append(n)
            }, oa = function () {
                a(".tools_flyout").each(function () {
                    var k = a("#" + this.id + "_show"), n = k.offset();
                    k = k.outerWidth();
                    a(this).css({left: (n.left + k) * R, top: n.top})
                })
            }, ma = function () {
                a(".tools_flyout").each(function () {
                ...
                if (k.indexOf("url(#") === 0) {
                    ...
                    u = {alpha: n};
                    u[k.tagName] = k
                } else u = k.indexOf("#") === 0 ? {alpha: n, solidColor: k.substr(1)} : {alpha: n, solidColor: "none"};
            ...
            var Sa = b.setImageURL = function (k) {
                ...
                Ia = function () {
                    ...
                    var n = e.getCurrentDrawing().getCurrentLayerName(), q = e.getMode(),
                        u = curConfig.baseUnit !== "px" ? curConfig.baseUnit : null, E = q == "pathedit";
                    if (E) {
                        ...
                        if (k != null) {
                            a("#stroke_panel").show();
                            var K = k.nodeName, O = e.getRotationAngle(k);
                            ...
                            if (!E && q != "pathedit") {
                                ...
                                var V, aa;
                                if (["g", "polyline", "path"].indexOf(K) >= 0) if (q = e.getStrokedBBox([k])) {
                                    V = q.x;
                                    aa = q.y
                                }
                                if (u) {
                            ...
                            if (k.parentNode.tagName === "a") if (!a(k).siblings().length) {
                                a("#a_panel").show();
                            ...
                            if (u[S]) {
                                ...
                                } else if (S == "image") Sa(e.getHref(k)); else if (S === "g" || S === "use") {
            ...
            e.bind("selected", function (k, n) {
                ...
                e.runExtensions("selectedChanged", {elems: n, selectedElement: X, multiselected: W})
            });
            e.bind("transition", function (k, n) {
                var q = e.getMode(), u = n[0];
                if (u) {
                    ...
                    e.runExtensions("elementTransition", {elems: n})
                }
            });
            e.bind("changed", function (k, n) {
                ...
                for (var u = 0; u < n.length; ++u) {
                    var E = n[u];
                    if (E && E.tagName === "svg") G(); else if (E && X && X.parentNode == null) X = E
                }
                ...
                e.runExtensions("elementChanged", {elems: n})
            });
            e.bind("saved", function (k, n) {
                ...
                if (~q.indexOf("MSIE")) Eb(0, true); else {
                    var u = k.open("data:image/svg+xml;base64," + L.encode64(n)), E = a.pref("save_notice_done");
                    if (E !== "all") {
                        var I = uiStrings.notification.saveFromBrowser.replace("%s", "SVG");
                        if (q.indexOf("Gecko/") !== -1) if (n.indexOf("<defs") !== -1) {
                            I += "\n\n" + uiStrings.notification.defsFailOnSave;
                            a.pref("save_notice_done", "all");
                            E = "all"
                        } else a.pref("save_notice_done", "part"); else a.pref("save_notice_done", "all");
                        E !== "part" && u.alert(I)
                    }
                }
            });
            e.bind("exported", function (k, n) {
                var q = n.issues;
                a("#export_canvas").length || a("<canvas>", {id: "export_canvas"}).hide().appendTo("body");
            ...
            e.bind("extension_added", function (k, n) {
                ...
                var u = false, E = false, I = true, K = function () {
                    if (n.callback && !u && I) {
                        u = true;
                        n.callback()
                    }
                ...
                n.context_tools && a.each(n.context_tools, function (ga, T) {
                    var qa = T.container_id ? ' id="' + T.container_id + '"' : "", va = a("#" + T.panel);
                    va.length || (va = a("<div>", {id: T.panel}).appendTo("#tools_top").hide());
                    switch (T.type) {
                        case "tool_button":
                            var za = '<div class="tool_button">' + T.id + "</div>", Aa = a(za).appendTo(va);
                ...
                if (n.buttons) {
                    ...
                    a.each(n.buttons, function (ga, T) {
                        ...
                        if (S) {
                            ...
                            if (T.type == "app_menu") aa["#" + va + " > div"] = za; else aa["#" + va] = za
                        ...
                        switch (T.type) {
                            ...
                            case "context":
                                Aa = "tool_button";
                                Oa = "#" + T.panel;
                                a(Oa).length || a("<div>", {id: T.panel}).appendTo("#tools_top");
                                break;
                            case "menu":
                        ...
                        if (!T.includeWith && !T.list) {
                            if ("position" in T) a(Oa).children().eq(T.position).before(Pa); else T.type != "menu" || !T.after ? Pa.appendTo(Oa) : a(Oa).after(Pa);
                            if (T.type == "mode_flyout") {
                                ...
                                if (!za.parent().hasClass("tools_flyout")) {
                                    var La =
                                        ...
                                        jb = za.clone().attr("id", La + "_show").append(a("<div>", {"class": "flyout_arrow_horiz"}));
                                    za.before(jb);
                                    Aa = pa(La, za);
                            ...
                            va = ea["#" + Aa[0].id] = [{
                                ...
                                icon: T.id,
                                key: T.key,
                                isDefault: T.includeWith ? T.includeWith.isDefault :
                                    0
                            }, ub];
                            La = "position" in Oa ? Oa.position : "last";
                            ub = Aa.children().length;
                            if (!isNaN(La) && La >= 0 && La < ub) Aa.children().eq(La).before(Pa); else {
                                Aa.append(Pa);
                                va.reverse()
                            }
                        }
                        ...
                        T.list || a.each(T.events, function (Cb, Jb) {
                            ...
                            } else Pa.bind(Cb, Jb); else Pa.bind(Cb, Jb)
                        });
                        da(ea)
                    });
                    a.each(O, function () {
                        vb(this.elem, this.list,
                            this.callback, {seticon: true})
                    });
                    if (S) I = false;
                    a.svgIcons(S, {
                        w: 27,
            ...
            ["#444444", "#482816", "#422C10", "#3B2F0E", "#32320F", "#293414",
                ...
                "#BBBBBB", "#FFB27C", "#FABA6F", "#E6C36A", "#CFCA6D", "#B8D078", "#A0D58A", "#8CD79F", "#7DD8B5", "#7AD6CA", "#84D3DB", "#9ACEE6", "#B6C7EA", "#D3BEE7", "#EDB6DC", "#FFAFCC", "#FFAAB8", "#FFA9A2", "#FFAC8D", "#DDDDDD", "#FFE7A2", "#FFF093", "#FFFA8D", "#FFFF91", "#EEFF9F", "#D1FFB4", "#B9FFCE", "#A8FFE9", "#A4FFFF", "#B1FFFF", "#CBFFFF", "#EDFFFF", "#FFF5FF", "#FFEBFF", "#FFE2FF", "#FFDCEC", "#FFDBD2", "#FFDFB8"].forEach(function (k) {
            ...
            changeAttribute = function (k) {
                var n = k.getAttribute("data-attr"), q = k.getAttribute("data-multiplier") || 1;
                q = parseFloat(q);
                q = k.value * q;
            ...
            a("#palette").on("mousemove mousedown touchstart touchmove", ".palette_item", function (k) {
                ...
                if (picking) {
                    var n = a("#tool_stroke").hasClass("active"), q = n ? "stroke" : "fill",
                        u = a(this).attr("data-rgb"), E = null, I = true;
                    if (k.type == "mousedown") I = false;
                    if (u === "transparent" ||
                        u === "initial" || u === "#none") {
                        u = "none";
                        E = new a.jGraduate.Paint
                    } else E = new a.jGraduate.Paint({alpha: 100, solidColor: u.substr(1)});
            ...
            (function () {
                var k = null, n = null, q = J[0], u = false,
                    E = false;
            ...
            a("svg, body").on("mousedown  touchstart", function (k) {
                if (!(k.target.nodeName && k.target.nodeName.toLowerCase() === "input")) if (!a(k.target).hasClass("menu_title") && !a(k.target).parent().hasClass("menu_title")) !a(k.target).hasClass("disabled") && a(k.target).hasClass("menu_item") ? kb(k) : a("#menu_bar").removeClass("active")
            });
            ...
            b.addDropDown = function (k, n, q) {
                if (a(k).length != 0) {
                    var u = a(k).find("button"), E = a(k).find("ul").attr("id",
                        a(k)[0].id + "-list");
                    ...
                    u.bind("mousedown", function () {
                        if (u.hasClass("down")) {
                            ...
                            if (!q) {
                                var K = a(k).offset();
                                E.css({top: K.top, left: K.left - 110})
                            }
                            E.show();
                            I = true
                        }
            ...
            a("#font_family_dropdown").change(function () {
                var k = this.options[this.selectedIndex].value, n = this.options[this.selectedIndex].text;
            ...
            var cb = function () {
                ...
                ya(a("#edit_menu"));
                var k = e.getZoom(), n = (J[0].scrollLeft + J.width() / 2) / k - e.contentW;
                ...
                var k = a("#tool_add_subpath"), n = !k.hasClass("push_button_pressed");
                ...
                var n = k.prev();
                n.css({background: "white", color: "black"});
                setTimeout(function () {
                    n.removeAttr("style")
                }, 200)
            }, qb = function () {
                ...
                var n = document.querySelector("#tool_fill rect"), q = n.getAttribute("fill"),
            ...
            gb = function () {
                var k = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/, n = document.getElementsByTagName("script")[0], q;
                for (q in n.style) if (k.test(q)) return q.match(k)[0];
            ...
            var Nb =
                function (k, n) {
                    ...
                    k.each(function () {
                        for (var u = a(this), E = u.outerWidth() * (n - 1), I = u.outerHeight() * (n - 1), K = 0; K < 4; K++) {
                            var O = q[K], V = u.data("orig_margin-" + O);
                            if (V == null) {
                                V = parseInt(u.css("margin-" + O));
                                u.data("orig_margin-" + O, V)
                            }
                            V = V * n;
                            if (O === "right") V += E; else if (O === "bottom") V += I;
                            u.css("margin-" + O, V)
                        }
                    })
                ...
                if (!(k == s.size && !n)) {
                    var q = a("#tools_top .toolset, #editor_panel > *, #history_panel > *,        #main_button, #tools_left > *, #path_node_panel > *, #multiselected_panel > *,        #g_panel > *, #tool_font_size > *, .tools_flyout"),
                        u = 1;
                    u = typeof k == "number" ? k : {s: 0.75, m: 1, l: 1.25, xl: 1.5}[k];
                    b.tool_scale = R = u;
                    oa();
                    ...
                    q = a("#tool_size_rules");
                    if (q.length) q.empty(); else q = a('<style id="tool_size_rules"></style>').appendTo("head");
                    if (k != "m") {
                        var I = "";
                        a.each(cssResizeRules, function (K, O) {
                            ...
                            a.each(O, function (V, aa) {
                                if (typeof aa === "number") var S = aa * u + "px"; else if (aa[k] || aa.all) S =
                                    aa[k] || aa.all;
                                I += V + ":" + S + ";"
                            });
                            I += "}"
            ...
            d = function (k, n) {
                var q = document.getElementById("canvas_background"), u = {color: "fff", opacity: 1};
                ...
                this.paint = new a.jGraduate.Paint({solidColor: u.color});
                this.type = n;
                this.setPaint = function (E, I) {
                    this.paint = E;
                    var K = "none", O = E.type, V = E.alpha / 100;
                    switch (O) {
                        case "solidColor":
                    ...
                    if (this.type == "canvas") if (O = document.getElementById("canvas_background")) {
                        Fa = e.getResolution();
                        O.setAttribute("x", -1);
                        O.setAttribute("y", -1);
                ...
                this.prep = function () {
                    switch (this.paint.type) {
                        ...
                        case "radialGradient":
                            var E =
                                new a.jGraduate.Paint({copy: this.paint});
                            e.setPaint(n, E)
                    }
                }
            };
            ...
            a("#tool_fill").click(function () {
                if (a("#tool_fill").hasClass("active")) f(a("#fill_color")); else {
                    a("#tool_fill").addClass("active");
                    a("#tool_stroke").removeClass("active")
                }
            });
            a("#tool_stroke").on("click", function () {
                if (a("#tool_stroke").hasClass("active")) f(a("#stroke_color")); else {
            ...
            var m = function () {
                var k = a("#canvas_width"), n = a("#canvas_height"), q = k.val(), u = n.val();
            ...
            a("#resolution").change(function () {
                var k = a("#canvas_width")[0], n = a("#canvas_height")[0];
                if (this.selectedIndex) if (this.value == "content") {
                    k.value = "fit";
                    n.value = "fit";
                    m();
                    ...
                    u[0] = parseInt(u[0]);
                    u[1] = parseInt(u[1]);
                    var E = u[0] - k.value, I = u[1] - n.value, K = Date.now(), O = function () {
                        var V = (Date.now() -
                            K) / 1E3;
                        V = Math.pow(V - 1, 3) + 1;
            ...
            var B = function () {
                var k = [{sel: "#tool_select", fn: cb, evt: "click", key: ["V", true]}, {
                        sel: "#tool_fhpath",
                        fn: Ta,
                        evt: "click",
                        key: ["Q", true]
                    }, {sel: "#tool_line", fn: Va, evt: "click", key: ["L", true]}, {
                        sel: "#tool_rect",
                        fn: Da,
                        evt: "click",
                        key: ["R", true],
                        ...
                        key: ["C", true],
                        icon: "ellipse"
                    }, {sel: "#tool_path", fn: db, evt: "click", key: ["P", true]}, {
                        sel: "#tool_text",
                        fn: Ea,
                        evt: "click",
                        key: ["T", true]
                    }, {sel: "#tool_image", fn: $a, evt: "mouseup"},
                        {sel: "#tool_zoom", fn: Ga, evt: "mouseup", key: ["Z", true]}, {
                            sel: "#tool_clear",
                            fn: Ma,
                            evt: "mouseup",
                            key: [w + "N", true]
                            ...
                            sel: "#tool_save", fn: function () {
                                if (fa) Kb(); else {
                                    ya(a("#file_menu"));
                                    e.save({images: s.img_save, round_digits: 6})
                                }
                            }, evt: "mouseup", key: [w + "S", true]
                        }, {sel: "#tool_export", fn: nb, evt: "mouseup"}, {
                            sel: "#tool_open",
                            fn: Qa,
                            evt: "mouseup"
                        }, {sel: "#tool_import", fn: mb, evt: "mouseup"}, {
                            sel: "#tool_source",
                            fn: Eb,
                            evt: "click",
                            key: [w + "U", true]
                        }, {sel: "#tool_wireframe", fn: Hb, evt: "click"}, {sel: "#tool_snap", fn: Gb, evt: "click"},
                        {
                            sel: "#tool_rulers",
                            fn: Lb,
                            evt: "click"
                            ...
                            key: ["esc", false, false],
                            hidekey: true
                        }, {sel: "#tool_source_save", fn: Kb, evt: "click"}, {
                            ...
                            fn: tb,
                            evt: "change"
                        }, {sel: "#tool_node_clone", fn: ha, evt: "click"}, {
                            ...
                            fn: M, evt: "click"
                        }, {sel: "#tool_add_subpath", fn: ja, evt: "click"}, {
                            sel: "#tool_move_top",
                            fn: sa,
                            evt: "click",
                            key: w + "shift+up"
                        }, {sel: "#tool_move_bottom", fn: hb, evt: "click", key: w + "shift+down"}, {
                            sel: "#tool_move_up",
                            fn: eb,
                            evt: "click",
                            key: [w + "up", true]
                        }, {sel: "#tool_move_down", fn: sb, evt: "click", key: [w + "down", true]}, {
                            sel: "#tool_topath",
                            fn: ab,
                            evt: "click"
                        }, {
                            ...
                            fn: pb,
                            evt: "click"
                        }, {sel: "#tool_clone,#tool_clone_multi", fn: Fb, evt: "click", key: [w + "D", true]}, {
                            sel: "#tool_group", fn: Bb,
                            evt: "click", key: [w + "G", true]
                        }, {sel: "#tool_ungroup", fn: Bb, evt: "click", key: w + "shift+G"}, {
                            sel: "#tool_unlink_use",
                            fn: Bb,
                            evt: "click"
                        }, {sel: "[id^=tool_align]", fn: bb, evt: "click"}, {
                            sel: "#tool_undo",
                            fn: qb,
                            evt: "click",
                            key: w + "z"
                        }, {sel: "#tool_redo", fn: rb, evt: "click", key: ["y", true]}, {
                            sel: "#tool_cut",
                            fn: Ua,
                            evt: "click",
                            key: [w + "x", true]
                        }, {sel: "#tool_copy", fn: Xa, evt: "click", key: w + "c"}, {
                            sel: "#tool_paste",
                            fn: wb,
                            evt: "click",
                            key: w + "v"
                        }, {sel: "#tool_switch", fn: Ha, evt: "click", key: ["x", true]}, {
                            sel: "#tool_bold", fn: Wa, evt: "mousedown",
                            key: [w + "B", true]
                        }, {sel: "#tool_italic", fn: Za, evt: "mousedown", key: [w + "I", true]}, {
                            sel: "#copy_save_done",
                            fn: Ab,
                            evt: "click"
                        }, {
                        ...
                        }, {key: "shift+O", fn: ba}, {key: "shift+P", fn: P}, {
                            key: [w + "+", true], fn: function () {
                                yb(2)
                            }
                        }, {
                            key: [w + "-", true], fn: function () {
                        ...
                        }, {key: w + "shift+z", fn: rb}, {key: "esc", fn: Ib}],
                    n = {"4/Shift+4": "#tools_rect_show", "5/Shift+5": "#tools_ellipse_show"};
                return {
                    setAll: function () {
                        var q = {};
                        ...
                        a.each(n, function (q, u) {
                            ...
                            a(u).each(function () {
                                var I = E ? a(this).text().split(" [")[0] : this.title.split(" [")[0], K = "";
                                ...
                                if (E) this.lastChild.textContent = I + " [" + K + "]"; else this.title = I + " [" + K + "]"
                            })
                        })
            ...
            B.setAll();
            b.ready(function () {
                var k = curConfig.initTool, n = a("#tools_left, #svg_editor .tools_flyout"), q = n.find("#tool_" + k);
                k = n.find("#" + k);
            ...
            a("#canvas_height").dragInput({min: 10, max: null, step: 10, callback: m, cursor: false, dragAdjust: 0.1});
            a("#canvas_width").dragInput({min: 10, max: null, step: 10, callback: m, cursor: false, dragAdjust: 0.1});
            a("#rect_width").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#rect_height").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#ellipse_cx").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#ellipse_cy").dragInput({
                min: 1, max: null,
                step: 1, callback: changeAttribute, cursor: false
            });
            a("#ellipse_rx").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#ellipse_ry").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#image_height").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#circle_cx").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#circle_cy").dragInput({min: 1, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#circle_r").dragInput({
                min: 1,
                max: null, step: 1, callback: changeAttribute, cursor: false
            });
            a("#image_height").dragInput({min: 0, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#selected_x").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#selected_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#path_node_x").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#path_node_y").dragInput({
                min: null, max: null, step: 1, callback: changeAttribute,
                cursor: false
            });
            a("#image_width").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#line_x1").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#line_x2").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#line_y1").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#line_y2").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#path_x").dragInput({
                min: null,
                max: null, step: 1, callback: changeAttribute, cursor: false
            });
            a("#path_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#rect_x").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#rect_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#g_x").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#g_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#image_x").dragInput({
                min: null,
                max: null, step: 1, callback: changeAttribute, cursor: false
            });
            a("#text_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#text_x").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#image_y").dragInput({min: null, max: null, step: 1, callback: changeAttribute, cursor: false});
            a("#rect_rx").dragInput({min: 0, max: 100, step: 1, callback: changeAttribute, cursor: true});
            a("#stroke_width").dragInput({
                min: 0, max: 99, step: 1, callback: function (k) {
                    var n = k.value;
                    if (n == 0 &&
                        X && ["line", "polyline"].indexOf(X.nodeName) >= 0) n = k.value = 1;
                    e.setStrokeWidth(n)
                }, cursor: true, smallStep: 0.1, start: 1.5
            });
            a("#angle").dragInput({
                min: -180, max: 180, step: 1, callback: function (k) {
                    e.setRotationAngle(k.value, true);
                    rotateCursor(k.value);
                    a("#tool_reorient").toggleClass("disabled", k.value == 0)
                }, cursor: false, dragAdjust: 0.5
            });
            a("#font_size").dragInput({
                min: 1, max: 250, step: 1, callback: function (k) {
                    e.setFontSize(k.value)
                }, cursor: true, stepfunc: function (k, n) {
                    var q = k.value - 0, u = q + n, E = u >= q;
                    if (n === 0) return q;
            ...
            a("#blur").dragInput({
                min: 0, max: 10, step: 0.1, callback: function (k, n) {
                    val = k.value;
                    a("#blur").val(val);
            ...
            a("#workarea").contextMenu({menu: "cmenu_canvas", inSpeed: 0}, function (k) {
                switch (k) {
                    case "delete":
                        lb();
                        break;
            ...
            if (window.FileReader) {
                d = function (k) {
                    ...
                    a("#main_menu").hide();
                    var n = null;
                    if (n = k.type == "drop" ? k.dataTransfer.files[0] : this.files[0]) if (n.type.indexOf("image") != -1) if (n.type.indexOf("svg") != -1) {
                        k = new FileReader;
            ...
            var G = b.updateCanvas = function (k, n) {
                    var q = J.width(), u = J.height(), E = q, I = u, K = e.getZoom(), O = J, V = a("#svgcanvas"),
                        aa = {x: O[0].scrollLeft + E / 2, y: O[0].scrollTop + I / 2}, S = curConfig.canvas_expansion;
                    ...
                    var ea = V.width() / 2;
                    V.width(q).height(u);
                    var ga = u / 2, T = q / 2, qa = e.updateCanvas(q, u), va = T / ea;
                    q = q / 2 - E / 2;
                    u = u / 2 - I / 2;
                    if (n) {
                        n.x += qa.x;
                        n.y += qa.y
                    } else n = {x: T + (aa.x - ea) * va, y: ga + (aa.y - S) * va};
                    if (k) if (e.contentW > O.width()) {
            ...
            try {
                var z = function (k) {
                    ...
                    if (typeof k == "boolean" || typeof k == "number") return k + ""; else if (typeof k == "string") return '"' + k.replace(/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, function (E) {
        ...
        b.loadFromURL = function (d, p) {
            p || (p = {});
            var w = p.cache, C = p.callback;
            b.ready(function () {
                a.ajax({
                    url: d, dataType: "text", cache: !!w, success: function (v) {
                        o(v, C)
...
$.fn.dragInput = function (a) {
    return this.each(function () {
        ...
        var o = this.dragCfg.dragAdjust, e = $(this).parent(), b = $(this), l = this.dragCfg.height,
            s = this.dragCfg.min, c = this.dragCfg.max, g = this.dragCfg.step, d = c - s > 0 ? (c - s) / g : 200,
            p = d / l * g, w = 0, C = this.getAttribute("data-attr"), v = methodDraw.canvas,
            L = svgedit.browser.isTouch(), Q = true,
        ...
        this.launch = function (H) {
            ...
            if (L) H = H.originalEvent.touches[0];
            var R = H.pageY, N = this.value, ca = this;
        ...
        $(this).attr("readonly", "readonly").attr("data-scale", p).attr("data-domain", l).attr("data-cursor", J != false).bind("mousedown touchstart", function (H) {
            ...
            var ca =
                this;
            if (N > 0) this.adjustValue(this.dragCfg.step); else N < 0 && this.adjustValue(-this.dragCfg.step);
            H.preventDefault()
        })
    })
};
$.fn.dragInput.updateCursor = function (a) {
    var o = parseFloat(a.value), e = parseFloat(a.getAttribute("data-scale")),
...
(function () {
    ...
    svgedit.contextmenu.add = function (o) {
        if (o && o.id && o.label && o.action && typeof o.action == "function") if (o.id in a.contextMenuExtensions) console.error('Cannot add extension "' + o.id + '", an extension by that name already exists"'); else {
...
(function (a, o) {
    ...
    a.ui.version || (a.extend(a.ui, {
        ...
        propAttr: a.fn.prop || a.fn.attr, _focus: a.fn.focus, focus: function (l, s) {
        ...
        var g = s === "Width" ? ["Left", "Right"] : ["Top", "Bottom"], d = s.toLowerCase(), p = {
        ...
        var l = document.body, s = l.appendChild(s = document.createElement("div"));
        a.extend(s.style, {minHeight: "100px", height: "auto", padding: 0, borderWidth: 0});
        ...
        plugin: {
            add: function (l, s, c) {
                ...
                if ((s = l.plugins[s]) &&
                    l.element[0].parentNode) for (var g = 0; g < s.length; g++) l.options[s[g][0]] && s[g][1].apply(l.element, c)
            }
            ...
            var c = s && s === "left" ? "scrollLeft" : "scrollTop", g = false;
...
(function (a, o) {
    if (a.cleanData) {
        ...
        a.cleanData = function (l) {
            for (var s = 0, c; (c = l[s]) != null; s++) try {
    ...
    a.widget.bridge = function (l, s) {
        a.fn[l] = function (c) {
            var g = typeof c == "string", d = Array.prototype.slice.call(arguments, 1), p = this;
            c = !g && d.length ? a.extend.apply(null, [true, c].concat(d)) :
                c;
            if (g && c.charAt(0) === "_") return p;
            g ? this.each(function () {
                var w = a.data(this, l), C = w && a.isFunction(w[c]) ? w[c].apply(w, d) : w;
                if (C !== w && C !== o) {
                    p = C;
                    return false
                }
    ...
    a.Widget.prototype = {
        widgetName: "widget", widgetEventPrefix: "", options: {disabled: false}, _createWidget: function (l, s) {
            ...
            if (l = s.originalEvent) for (g in l) g in s || (s[g] = l[g]);
...
(function (a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseStart: function (o) {
            ...
            a.extend(this.offset, {
                click: {left: o.pageX - this.offset.left, top: o.pageY - this.offset.top},
        ...
        _adjustOffsetFromHelper: function (o) {
            ...
            a.isArray(o) && (o = {left: +o[0], top: +o[1] || 0});
        ...
        _generatePosition: function (o) {
            var e = this.options, b = this.cssPosition == "absolute" &&
                ...
                l = /(html|body)/i.test(b[0].tagName), s = o.pageX, c = o.pageY;
    ...
    a.ui.plugin.add("draggable", "connectToSortable", {
        start: function (o, e) {
            var b = a(this).data("draggable"), l = b.options, s = a.extend({}, e, {item: b.element});
            b.sortables = [];
            a(l.connectToSortable).each(function () {
                var c = a.data(this, "sortable");
                c && !c.options.disabled && (b.sortables.push({instance: c, shouldRevert: c.options.revert}),
                    c.refreshPositions(), c._trigger("activate", o, s))
            })
        }, stop: function (o, e) {
            var b = a(this).data("draggable"), l = a.extend({}, e, {item: b.element});
            ...
            var b = a(this).data("draggable"), l = this;
            a.each(b.sortables, function () {
    ...
    a.ui.plugin.add("draggable", "cursor", {
        start: function () {
            var o = a("body"), e = a(this).data("draggable").options;
    ...
    a.ui.plugin.add("draggable", "scroll", {
        start: function () {
            ...
            var e = a(this).data("draggable"), b = e.options, l = false;
    ...
    a.ui.plugin.add("draggable", "snap", {
        start: function () {
            var o = a(this).data("draggable"), e = o.options;
            o.snapElements = [];
            a(e.snap.constructor != String ? e.snap.items || ":data(draggable)" : e.snap).each(function () {
                var b = a(this), l = b.offset();
                this != o.element[0] && o.snapElements.push({
                    item: this,
                    width: b.outerWidth(), height: b.outerHeight(), top: l.top, left: l.left
                })
            })
        }, drag: function (o, e) {
            for (var b = a(this).data("draggable"), l = b.options, s = l.snapTolerance, c = e.offset.left, g = c + b.helperProportions.width, d = e.offset.top, p = d + b.helperProportions.height, w = b.snapElements.length - 1; w >= 0; w--) {
                var C = b.snapElements[w].left, v = C + b.snapElements[w].width, L = b.snapElements[w].top,
                    Q = L + b.snapElements[w].height;
                if (C - s < c && c < v + s && L - s < d && d < Q + s || C - s < c && c < v + s && L - s < p && p < Q + s || C - s < g && g < v + s && L - s < d && d < Q + s || C - s < g && g < v + s && L - s < p &&
                    p < Q + s) {
                    if (l.snapMode != "inner") {
                        var J = Math.abs(L - p) <= s, H = Math.abs(Q - d) <= s, U = Math.abs(C - g) <= s,
                            R = Math.abs(v - c) <= s;
                        J && (e.position.top = b._convertPositionTo("relative", {
                            top: L - b.helperProportions.height,
                            left: 0
                        }).top - b.margins.top);
                        H && (e.position.top = b._convertPositionTo("relative", {top: Q, left: 0}).top - b.margins.top);
                    ...
                    if (l.snapMode != "outer") {
                        ...
                        U = Math.abs(C - c) <= s;
                        R = Math.abs(v - g) <= s;
                        J && (e.position.top = b._convertPositionTo("relative", {top: L, left: 0}).top - b.margins.top);
                    ...
                    (J || H || U || R || N) && b.options.snap.snap && b.options.snap.snap.call(b.element, o, a.extend(b._uiHash(), {snapItem: b.snapElements[w].item}));
                    b.snapElements[w].snapping = J || H || U || R || N
                } else {
                    b.snapElements[w].snapping && b.options.snap.release && b.options.snap.release.call(b.element, o, a.extend(b._uiHash(), {snapItem: b.snapElements[w].item}));
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function () {
            var o = this, e = this.options,
                ...
                l = e.values && e.values.length || 1, s = [];
            ...
            this.handles.keydown(function (g) {
                var d = true, p = a(this).data("index.ui-slider-handle"), w, C, v;
        ...
        _mouseCapture: function (o) {
            var e = this.options, b, l, s, c, g;
            if (e.disabled) return false;
            this.elementSize = {width: this.element.outerWidth(), height: this.element.outerHeight()};
            this.elementOffset = this.element.offset();
            b = this._normValueFromMouse({x: o.pageX, y: o.pageY});
        ...
        _mouseDrag: function (o) {
            var e =
                this._normValueFromMouse({x: o.pageX, y: o.pageY});
        ...
        _start: function (o, e) {
            var b = {handle: this.handles[e], value: this.value()};
        ...
        _trimAlignValue: function (o) {
            ...
            var e = this.options.step > 0 ? this.options.step : 1, b = (o - this._valueMin()) % e;
            o = o - b;
        ...
        _refreshValue: function () {
            var o =
                    this.options.range, e = this.options, b = this, l = this._animateOff ? false : e.animate, s, c = {}, g,
                d, p, w;
            this.options.values && this.options.values.length ? this.handles.each(function (C) {
                ...
                b.options.range === true && (b.orientation === "horizontal" ? (C === 0 && b.range.stop(1, 1)[l ? "animate" : "css"]({left: s + "%"}, e.animate), C === 1 && b.range[l ? "animate" : "css"]({
                    width: s -
                        g + "%"
                }, {
                    queue: false,
                    duration: e.animate
                })) : (C === 0 && b.range.stop(1, 1)[l ? "animate" : "css"]({bottom: s + "%"}, e.animate), C === 1 && b.range[l ? "animate" : "css"]({height: s - g + "%"}, {
                    queue: false,
                    duration: e.animate
                })));
                g = s
            }) : (d = this.value(), p = this._valueMin(), w = this._valueMax(), s = w !== p ? (d - p) / (w - p) * 100 : 0, c[b.orientation === "horizontal" ? "left" : "bottom"] = s + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](c, e.animate), o === "min" && this.orientation === "horizontal" && this.range.stop(1, 1)[l ? "animate" : "css"]({width: s + "%"}, e.animate),
            o === "max" && this.orientation === "horizontal" && this.range[l ? "animate" : "css"]({width: 100 - s + "%"}, {
                queue: false,
                duration: e.animate
            }), o === "min" && this.orientation === "vertical" && this.range.stop(1, 1)[l ? "animate" : "css"]({height: s + "%"}, e.animate), o === "max" && this.orientation === "vertical" && this.range[l ? "animate" : "css"]({height: 100 - s + "%"}, {
                queue: false,
                duration: e.animate
            }))
        }
...
(function (a) {
    ...
    var o = function (c, g) {
        var d = this, p = c.find("img:first"), w = 0, C = 100, v = 100, L = 0, Q = 100, J = 100, H = 0, U = 0, R, N,
            ca = [], la = function (Z) {
                ...
                Z = Z.pageY - R.t;
                var pa = c.w, oa = c.h;
                if (da < 0) da = 0; else if (da > pa) da = pa;
                if (Z < 0) Z = 0; else if (Z > oa) Z = oa;
                ia.call(d, "xy", {x: da / pa * v + w, y: Z / oa * J + L})
            }, ia = function (Z, da, pa) {
                if (da === undefined) {
                ...
                if (!(pa != null && pa == d)) {
                    ...
                    if (ma != null) {
                        if (ma < w) ma = w; else if (ma > C) ma = C;
                        if (H != ma) {
                            H = ma;
                            oa = true
                        }
                    ...
                    if (na != null) {
                        if (na < L) na = L; else if (na > Q) na = Q;
                        if (U != na) {
                            U = na;
                            oa = true
                        }
        ...
        a.extend(true, d, {
                ...
                if (da === undefined) {
                    ...
                    switch (Z.toLowerCase()) {
                        ...
                        case "maxx":
                            return C;
                        case "rangex":
                            return {minX: w, maxX: C, rangeX: v};
                        case "miny":
                            return L;
                        case "maxy":
                            return Q;
                        case "rangey":
                            return {minY: L, maxY: Q, rangeY: J};
                        default:
                            return {minX: w, maxX: C, rangeX: v, minY: L, maxY: Q, rangeY: J}
                    }
                }
                var pa, oa, ma, na;
                if (Z == null) Z = "all";
            ...
            unbind: function (Z) {
                if (a.isFunction(Z)) for (var da; (da = a.inArray(Z, ca)) != -1;) ca.splice(da, 1)
            }, destroy: function () {
                a(document).unbind("mouseup", fa).unbind("mousemove", W);
        ...
        c.bind("mousedown", X);
        ka.call(d, function () {
            var Z = 0, da = 0, pa = c.w, oa = c.h, ma = p.w, na = p.h;
            setTimeout(function () {
                if (v > 0) Z = H == C ?
                    pa : H / v * pa | 0;
                if (J > 0) da = U == Q ? oa : U / J * oa | 0;
                if (ma >= pa) Z = (pa >> 1) - (ma >> 1); else Z -= ma >> 1;
                if (na >= oa) da = (oa >> 1) - (na >> 1); else da -= na >> 1;
                p.css({left: Z + "px", top: da + "px"})
            }, 0)
        })
    }, e = function (c, g, d, p) {
        var w = this;
        c = c.find("td.Text input");
        var C = c.eq(3), v = c.eq(4), L = c.eq(5), Q = c.length > 7 ? c.eq(6) : null, J = c.eq(0), H = c.eq(1),
            U = c.eq(2), R = c.eq(c.length > 7 ? 7 : 6), N = c.length > 7 ? c.eq(8) : null, ca = function (ia) {
    ...
    a.jPicker = {
        List: [], Color: function (c) {
            var g = this, d, p, w, C, v, L, Q, J = [], H = function (R) {
                ...
                if (N === undefined) {
                    ...
                    switch (R.toLowerCase()) {
                        case "ahex":
                            return s.rgbaToHex({r: d, g: p, b: w, a: C});
                        case "hex":
                        ...
                        default:
                            ...
                            for (var la = 0; la < R.length; la++) switch (R.charAt(la)) {
                                case "r":
                                    if (R.length == 1) N = d; else N.r = d;
                                    break;
                                case "g":
                                    if (R.length == 1) N = p; else N.g = p;
                                    break;
                                case "b":
                                    if (R.length == 1) N = w; else N.b = w;
                                    break;
                                case "a":
                                    if (R.length == 1) N = C; else N.a = C;
                                    break;
                                case "h":
                                    if (R.length == 1) N = v;
                                    else N.h = v;
                                    break;
                                case "s":
                                    if (R.length == 1) N = L; else N.s = L;
                                    break;
                                case "v":
                                    if (R.length == 1) N = Q; else N.v = Q
                            }
                ...
                if (!(ca != null && ca == g)) {
                    ...
                    if (N == null) {
                        ...
                        case "hex":
                            ...
                            U.call(g,
                                "rgba", {r: N.r, g: N.g, b: N.b, a: R == "ahex" ? N.a : C != null ? C : 255}, ca);
                            break;
                        default:
                            ...
                            for (la = 0; la < R.length; la++) switch (R.charAt(la)) {
                                case "r":
                                    ...
                                    if (W.r < 0) W.r = 0; else if (W.r > 255) W.r = 255;
                                    if (d != W.r) {
                                        d = W.r;
                                        X = true
                                    }
                                ...
                                case "g":
                                    ...
                                    if (W.g < 0) W.g = 0; else if (W.g > 255) W.g = 255;
                                    if (p != W.g) {
                                        p = W.g;
                                        X = true
                                    }
                                ...
                                case "b":
                                    ...
                                    if (W.b < 0) W.b = 0; else if (W.b > 255) W.b = 255;
                                    if (w != W.b) {
                                        w = W.b;
                                        X = true
                                    }
                                ...
                                case "a":
                                    ...
                                    if (W.a <
                                        0) W.a = 0; else if (W.a > 255) W.a = 255;
                                    if (C != W.a) {
                                        C = W.a;
                                        X = true
                                    }
                                ...
                                case "h":
                                    ...
                                    if (W.h < 0) W.h = 0; else if (W.h > 360) W.h = 360;
                                    if (v != W.h) {
                                        v = W.h;
                                        X = true
                                    }
                                ...
                                case "s":
                                    ...
                                    if (W.s < 0) W.s = 0; else if (W.s > 100) W.s = 100;
                                    if (L != W.s) {
                                        L = W.s;
                                        X = true
                                    }
                                ...
                                case "v":
                                    ...
                                    if (W.v < 0) W.v = 0; else if (W.v > 100) W.v = 100;
                                    if (Q != W.v) {
                                        Q = W.v;
                                        X = true
                                    }
            ...
            a.extend(true, g, {
                val: U, bind: function (R) {
                    a.isFunction(R) && J.push(R)
                }, unbind: function (R) {
                    if (a.isFunction(R)) for (var N; (N = a.inArray(R, J)) != -1;) J.splice(N, 1)
                }, destroy: function () {
                    J = null
                }
            });
            if (c) if (c.ahex != null) U("ahex", c); else if (c.hex != null) U((c.a != null ? "a" : "") + "hex", c.a != null ? {ahex: c.hex + s.intToHex(c.a)} : c); else if (c.r != null &&
                c.g != null && c.b != null) U("rgb" + (c.a != null ? "a" : ""), c); else if (c.h != null && c.s != null && c.v != null) U("hsv" + (c.a != null ? "a" : ""), c)
        }, ColorMethods: {
            hexToRgba: function (c) {
                c = this.validateHex(c);
                if (c == "") return {r: null, g: null, b: null, a: null};
                var g = "00", d = "00", p = "00", w = "255";
                if (c.length == 6) c += "ff";
                if (c.length > 6) {
                    g = c.substring(0, 2);
                    d = c.substring(2, 4);
                ...
                return {r: this.hexToInt(g), g: this.hexToInt(d), b: this.hexToInt(p), a: this.hexToInt(w)}
                ...
                var g = c.r / 255, d = c.g / 255;
                c = c.b / 255;
                var p = {h: 0, s: 0, v: 0}, w = 0, C = 0;
                if (g >= d && g >= c) {
                    C = g;
                    w = d > c ? c : d
                } else if (d >= c && d >= g) {
                ...
                var g = {r: 0, g: 0, b: 0, a: 100}, d = c.h, p = c.s;
                c = c.v;
                if (p == 0) g.r = c == 0 ? g.g = g.b = 0 : g.g = g.b = c * 255 / 100 | 0; else {
                    if (d == 360) d = 0;
                    d /= 60;
                    p /= 100;
                    c /= 100;
    ...
    var b = a.jPicker.Color, l = a.jPicker.List, s = a.jPicker.ColorMethods;
    a.fn.jPicker = function (c) {
        var g = arguments;
        return this.each(function () {
            var d = this, p = a.extend(true, {}, a.fn.jPicker.defaults, c);
            if (a(d).get(0).nodeName.toLowerCase() ==
                "input") {
                a.extend(true, p, {window: {bindToInput: true, expandable: true, input: a(d)}});
                if (a(d).val() == "") {
                    p.color.active = new b({hex: null});
                    p.color.current = new b({hex: null})
                } else if (s.validateHex(a(d).val())) {
                    p.color.active = new b({hex: a(d).val(), a: p.color.active.val("a")});
                    p.color.current = new b({hex: a(d).val(), a: p.color.active.val("a")})
                }
            }
            ...
            var w = parseFloat(navigator.appVersion.split("MSIE")[1]) < 7 && document.body.filters, C = null, v = null,
                L = null, Q = null, J = null, H = null, U = null, R = null, N = null, ca = null, la = null, X = null,
                W = null, fa = null, ta = null, ia = null, ka = null, Z = null, da = null, pa = null, oa = null,
                ma = null, na = null, Ja = null, Fa = null, Na = null, Sa = null, Ia = null, Ka = function (M) {
                    var P = ja.active, ba = P.val("hex"), Ca, Ma;
                    p.color.mode = M;
                    switch (M) {
                        case "h":
                            setTimeout(function () {
                            ...
                            W.range("all", {minX: 0, maxX: 100, minY: 0, maxY: 100});
                            fa.range("rangeY", {minY: 0, maxY: 360});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("s"), y: 100 - P.val("v")}, W);
                        ...
                        case "s":
                            ...
                            W.range("all", {minX: 0, maxX: 360, minY: 0, maxY: 100});
                            fa.range("rangeY", {minY: 0, maxY: 100});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("h"), y: 100 - P.val("v")}, W);
                        ...
                        case "v":
                            ...
                            fa.range("rangeY", {minY: 0, maxY: 100});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("h"), y: 100 - P.val("s")}, W);
                            fa.val("y", 100 - P.val("v"), fa);
                            break;
                        case "r":
                            Ca = -1040;
                            Ma = -780;
                            W.range("all", {minX: 0, maxX: 255, minY: 0, maxY: 255});
                            fa.range("rangeY", {minY: 0, maxY: 255});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("b"), y: 255 - P.val("g")}, W);
                        ...
                        case "g":
                            ...
                            fa.range("rangeY", {minY: 0, maxY: 255});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("b"), y: 255 - P.val("r")}, W);
                        ...
                        case "b":
                            ...
                            fa.range("rangeY", {minY: 0, maxY: 255});
                            if (P.val("ahex") == null) break;
                            W.val("xy", {x: P.val("r"), y: 255 - P.val("g")}, W);
                    ...
                    if (!(P != fa && ba.val() == null)) switch (p.color.mode) {
                        case "h":
                            ba.val("h", {h: 360 - M.val("y")}, P);
                            break;
                        case "s":
                            ba.val("s", {s: 100 - M.val("y")}, P);
                            break;
                        case "v":
                            ba.val("v", {v: 100 - M.val("y")}, P);
                            break;
                        case "r":
                            ba.val("r", {r: 255 - M.val("y")}, P);
                            break;
                        case "g":
                            ba.val("g", {g: 255 - M.val("y")}, P);
                            break;
                        case "b":
                            ba.val("b", {b: 255 - M.val("y")}, P);
                            break;
                        case "a":
                    ...
                    if (P != W) switch (p.color.mode) {
                        case "h":
                            var ba = M.val("sv");
                            W.val("xy", {x: ba != null ? ba.s : 100, y: 100 - (ba != null ? ba.v : 100)}, P);
                            break;
                        case "s":
                        case "a":
                            ba = M.val("hv");
                            W.val("xy", {x: ba && ba.h || 0, y: 100 - (ba != null ? ba.v : 100)}, P);
                            break;
                        case "v":
                            ba = M.val("hs");
                            W.val("xy", {x: ba && ba.h || 0, y: 100 - (ba != null ? ba.s : 100)}, P);
                            break;
                        case "r":
                            ba = M.val("bg");
                            W.val("xy", {
                                x: ba &&
                                    ba.b || 0, y: 255 - (ba && ba.g || 0)
                            }, P);
                            break;
                        case "g":
                            ba = M.val("br");
                            W.val("xy", {x: ba && ba.b || 0, y: 255 - (ba && ba.r || 0)}, P);
                            break;
                        case "b":
                            ba = M.val("rg");
                            W.val("xy", {x: ba && ba.r || 0, y: 255 - (ba && ba.g || 0)}, P)
                    }
                    ...
                    try {
                        var P = M.val("all");
                        pa.css({backgroundColor: P && "#" + P.hex || "transparent"});
                    ...
                    switch (p.color.mode) {
                        case "h":
                            Ta.call(d, v, (new b({h: M.val("h") || 0, s: 100, v: 100})).val("hex"));
                            break;
                        case "s":
                        case "a":
                            var P = M.val("s");
                    ...
                    switch (p.color.mode) {
                        ...
                        case "s":
                            P = M.val("hva");
                            var ba = new b({h: P && P.h || 0, s: 100, v: P != null ? P.v : 100});
                        ...
                        case "v":
                            P = M.val("hsa");
                            ba = new b({h: P && P.h || 0, s: P != null ? P.s : 100, v: 100});
                            Ta.call(d, L, ba.val("hex"));
                            ua.call(d, la, Math.precision((255 - (P && P.a || 0)) * 100 / 255, 4));
                            break;
                        case "r":
                    ...
                    M.css({backgroundColor: P && P.length == 6 && "#" + P || "transparent"})
                }, Va = function (M, P) {
                    ...
                    } else M.css({backgroundImage: "url('" + P + "')"})
                }, Da = function (M, P) {
                    M.css({top: P + "px"})
                }, ua = function (M, P) {
                    M.css({visibility: P > 0 ? "visible" : "hidden"});
                    if (P > 0 && P < 100) if (w) {
                        ...
                        ba != null && (ba.indexOf("AlphaBar.png") != -1 || ba.indexOf("Bars.png") != -1 || ba.indexOf("Maps.png") != -1) ? M.css({
                            filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + ba + "', sizingMethod='scale') progid:DXImageTransform.Microsoft.Alpha(opacity=" +
                                P + ")"
                        }) : M.css({opacity: Math.precision(P / 100, 4)})
                    } else M.css({opacity: Math.precision(P / 100, 4)}); else if (P == 0 || P == 100) if (w) {
                        ba = M.attr("pngSrc");
                        ba != null && (ba.indexOf("AlphaBar.png") != -1 || ba.indexOf("Bars.png") != -1 || ba.indexOf("Maps.png") != -1) ? M.css({filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + ba + "', sizingMethod='scale')"}) : M.css({opacity: ""})
                    } else M.css({opacity: ""})
                }, $a = function () {
                ...
                Ra = function (M) {
                    ...
                    var P = M.val("hex");
                    oa.css({backgroundColor: P && "#" + P || "transparent"});
                    ua.call(d, oa, Math.precision((M.val("a") ||
                        0) * 100 / 255, 4))
                }, wb = function (M) {
                    var P = M.val("hex");
                    M = M.val("va");
                    Fa.css({backgroundColor: P && "#" + P || "transparent"});
                    ...
                    C.css({
                        left: ia -
                            (Z - M.pageX) + "px", top: ka - (da - M.pageY) + "px"
                    });
                    p.window.expandable && !a.support.boxModel && C.prev().css({left: C.css("left"), top: C.css("top")});
                    M.stopPropagation();
                    M.preventDefault();
                    return false
                }, eb = function (M) {
                    ...
                    return false
                }, ib = a.isFunction(g[1]) && g[1] || null, ab = a.isFunction(g[2]) && g[2] ||
                null, ob = a.isFunction(g[3]) && g[3] || null, pb = function () {
                    ja.current.val("ahex", ja.active.val("ahex"));
                    var M = function () {
                    ...
                    var M = p.window, P = M.expandable ? a(d).next().find(".Container:first") :
                        null;
                    ...
                    if (M.alphaPrecision < 0) M.alphaPrecision = 0; else if (M.alphaPrecision > 2) M.alphaPrecision = 2;
                    ...
                    var Ma = v.find("span"), Wa = L.find("span");
                    ...
                    W = new o(v, {
                        map: {width: ha.colorMap.width, height: ha.colorMap.height},
                        arrow: {
                    ...
                    W.bind(xa);
                    fa = new o(L, {
                        map: {width: ha.colorBar.width, height: ha.colorBar.height}, arrow: {
                            image: ha.clientPath +
                                ha.colorBar.arrow.file, width: ha.colorBar.arrow.width, height: ha.colorBar.arrow.height
                        }
                    });
                    fa.bind(ra);
                    ...
                    Wa = Ca.find(".Button");
                    pa = Za.find(".Active:first").css({backgroundColor: Ma && "#" + Ma || "transparent"});
                    oa = Za.find(".Current:first").css({backgroundColor: Ma && "#" + Ma || "transparent"}).bind("click", Ea);
                    ...
                    if (ja.quickList && ja.quickList.length > 0) {
                        ...
                        for (i = 0; i < ja.quickList.length; i++) {
                            if ((typeof ja.quickList[i]).toString().toLowerCase() == "string") ja.quickList[i] = new b({hex: ja.quickList[i]});
                            var nb = ja.quickList[i].val("a"), Qa = ja.quickList[i].val("ahex");
                    ...
                    if (M.expandable) {
                        ...
                        Sa = d.icon.find(".Image:first").css({backgroundImage: "url('" + ha.clientPath + ha.picker.file + "')"}).bind("click", Ua);
                    ...
                    p.images, Y = p.localization, ja = {
                    active: (typeof p.color.active).toString().toLowerCase() == "string" ? new b({ahex: !p.window.alphaSupport && p.color.active ? p.color.active.substring(0, 6) + "ff" : p.color.active}) : new b({ahex: !p.window.alphaSupport && p.color.active.val("ahex") ? p.color.active.val("ahex").substring(0, 6) + "ff" : p.color.active.val("ahex")}),
                    current: (typeof p.color.active).toString().toLowerCase() == "string" ? new b({ahex: !p.window.alphaSupport && p.color.active ? p.color.active.substring(0, 6) + "ff" : p.color.active}) :
                        new b({ahex: !p.window.alphaSupport && p.color.active.val("ahex") ? p.color.active.val("ahex").substring(0, 6) + "ff" : p.color.active.val("ahex")}),
    ...
    a.fn.jPicker.defaults = {
        ...
        color: {
            mode: "h",
            active: new b({ahex: "#ffcc00ff"}),
            quickList: [new b({h: 360, s: 33, v: 100}), new b({h: 360, s: 66, v: 100}), new b({
                h: 360,
                s: 100,
                v: 100
            }), new b({h: 360, s: 100, v: 75}), new b({h: 360, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 100
            }), new b({h: 30, s: 33, v: 100}), new b({h: 30, s: 66, v: 100}), new b({
                h: 30,
                s: 100,
                v: 100
            }), new b({h: 30, s: 100, v: 75}), new b({h: 30, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 90
            }), new b({h: 60, s: 33, v: 100}), new b({h: 60, s: 66, v: 100}), new b({
                h: 60,
                s: 100,
                v: 100
            }), new b({h: 60, s: 100, v: 75}), new b({h: 60, s: 100, v: 50}), new b({
                h: 180,
                s: 0, v: 80
            }), new b({h: 90, s: 33, v: 100}), new b({h: 90, s: 66, v: 100}), new b({
                h: 90,
                s: 100,
                v: 100
            }), new b({h: 90, s: 100, v: 75}), new b({h: 90, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 70
            }), new b({h: 120, s: 33, v: 100}), new b({h: 120, s: 66, v: 100}), new b({
                h: 120,
                s: 100,
                v: 100
            }), new b({h: 120, s: 100, v: 75}), new b({h: 120, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 60
            }), new b({h: 150, s: 33, v: 100}), new b({h: 150, s: 66, v: 100}), new b({
                h: 150,
                s: 100,
                v: 100
            }), new b({h: 150, s: 100, v: 75}), new b({h: 150, s: 100, v: 50}), new b({
                h: 180,
                s: 0,
                v: 50
            }), new b({h: 180, s: 33, v: 100}), new b({
                h: 180,
                s: 66, v: 100
            }), new b({h: 180, s: 100, v: 100}), new b({h: 180, s: 100, v: 75}), new b({
                h: 180,
                s: 100,
                v: 50
            }), new b({h: 180, s: 0, v: 40}), new b({h: 210, s: 33, v: 100}), new b({
                h: 210,
                s: 66,
                v: 100
            }), new b({h: 210, s: 100, v: 100}), new b({h: 210, s: 100, v: 75}), new b({
                h: 210,
                s: 100,
                v: 50
            }), new b({h: 180, s: 0, v: 30}), new b({h: 240, s: 33, v: 100}), new b({
                h: 240,
                s: 66,
                v: 100
            }), new b({h: 240, s: 100, v: 100}), new b({h: 240, s: 100, v: 75}), new b({
                h: 240,
                s: 100,
                v: 50
            }), new b({h: 180, s: 0, v: 20}), new b({h: 270, s: 33, v: 100}), new b({
                h: 270,
                s: 66,
                v: 100
            }), new b({h: 270, s: 100, v: 100}),
                new b({h: 270, s: 100, v: 75}), new b({h: 270, s: 100, v: 50}), new b({
                    h: 180,
                    s: 0,
                    v: 10
                }), new b({h: 300, s: 33, v: 100}), new b({h: 300, s: 66, v: 100}), new b({
                    h: 300,
                    s: 100,
                    v: 100
                }), new b({h: 300, s: 100, v: 75}), new b({h: 300, s: 100, v: 50}), new b({
                    h: 180,
                    s: 0,
                    v: 0
                }), new b({h: 330, s: 33, v: 100}), new b({h: 330, s: 66, v: 100}), new b({
                    h: 330,
                    s: 100,
                    v: 100
                }), new b({h: 330, s: 100, v: 75}), new b({h: 330, s: 100, v: 50}), new b]
        }, images: {
            clientPath: "/jPicker/images/",
            colorMap: {width: 256, height: 256, arrow: {file: "mappoint.gif", width: 15, height: 15}},
            colorBar: {
                width: 20,
                height: 256, arrow: {file: "rangearrows.gif", width: 20, height: 7}
            },
...
(function (a) {
    function o(l) {
        var s = l || window.event, c = [].slice.call(arguments, 1), g = 0, d = 0, p = 0;
        l = a.event.fix(s);
        l.type = "mousewheel";
    ...
    if (a.event.fixHooks) for (var b = e.length; b;) a.event.fixHooks[e[--b]] =
        a.event.mouseHooks;
    a.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener) for (var l = e.length; l;) this.addEventListener(e[--l], o, false); else this.onmousewheel = o
        }, teardown: function () {
            if (this.removeEventListener) for (var l = e.length; l;) this.removeEventListener(e[--l], o, false); else this.onmousewheel = null
        }
    };
    a.fn.extend({
...
methodDraw.addExtension("eyedropper", function (a) {
    var o = methodDraw.canvas, e = svgedit.history.ChangeElementCommand, b = {
        fillPaint: "red",
        fillOpacity: 1,
        strokePaint: "black",
        strokeOpacity: 1,
        ...
        if (s.indexOf("url(#") === 0) {
            ...
            d = {alpha: c};
            d[s.tagName] = s
        } else d = s.indexOf("#") === 0 ? {alpha: c, solidColor: s.substr(1)} : {alpha: c, solidColor: "none"};
...
methodDraw.addExtension("view_grid", function (a) {
    function o(p) {
        g.attr("width");
        g.attr("height");
        var w = svgedit.units.getTypeMap()[methodDraw.curConfig.baseUnit], C = [0.01, 0.1, 1, 10, 100, 1E3];
    ...
    if (!document.getElementById("canvasGrid")) {
        var e = document.getElementById("svgcanvas").ownerDocument, b = methodDraw.canvas, l = false;
        a = a.assignAttributes;
        var s = document.createElement("canvas");
        $(s).hide().appendTo("body");
        var c = e.createElementNS("http://www.w3.org/2000/svg",
            "g");
        a(c, {id: "canvasGrid", width: "100%", height: "100%", x: 0, y: 0, overflow: "visible", display: "none"});
        var g = $("#canvas_background");
        g.after(c);
        c = e.createElementNS("http://www.w3.org/2000/svg", "pattern");
        a(c, {id: "gridpattern", patternUnits: "userSpaceOnUse", x: 0, y: 0, width: 100, height: 100});
        var d = e.createElementNS("http://www.w3.org/2000/svg", "image");
        a(d, {x: 0, y: 0, width: 100, height: 100});
        c.appendChild(d);
    ...
    return {
        name: "view_grid", zoomChanged: function (p) {
            l && o(p)
        }, buttons: [{
            id: "view_grid", type: "menu", after: "tool_wireframe", panel: "view_menu", title: "View Grid", events: {
                click: function () {
...
methodDraw.addExtension("shapes", function () {
    ...
    function o(J) {
        ...
        if (H) {
            ...
            $.getJSON("extensions/shapelib/" + J + ".json", function (U) {
                L = v[J] = {data: U.data, size: U.size, fill: U.fill};
                e(J, U);
                a()
            })
        }
    ...
    function e(J, H) {
        var U = L.size || 300, R = L.fill || false, N = U * 0.05;
        ...
        for (var ca in R) {
            ...
            N = la.wrap('<div class="tool_button">').parent().attr({id: Q + "_" + ca, title: ca});
            L.buttons.push(N[0])
        }
    }

    var b, l, s = methodDraw.canvas, c, g, d, p = s.getRootElem(), w = {}, C = {
        basic: "Basic",
        object: "Objects",
        symbol: "Symbols",
        arrow: "Arrows",
    ...
    return {
        ...
        callback: function () {
            ...
            $("#tools_shapelib").css({"margin-top": -(J / 2), "margin-left": 3})
        },
        mouseDown: function (J) {
            if (s.getMode() === Q) {
                ...
                c = s.addSvgElementFromJson({
                    element: "path",
                    curStyles: true,
                    attr: {d: b, id: s.getNextId(), opacity: U.opacity / 2, style: "pointer-events:none"}
                });
                c.setAttribute("d", b);
                if (/[a-z]/.test(b)) {
        ...
        mouseMove: function (J) {
            if (s.getMode() ===
                Q) {
                var H = s.getZoom(), U = J.event, R = J.mouse_x / H, N = J.mouse_y / H;
                J = s.getTransformList(c);
                var ca = c.getBBox();
                H = ca.x;
                var la = ca.y, X = ca.width, W = ca.height, fa = R - g, ta = N - d,
                    ia = {x: Math.min(g, R), y: Math.min(d, N), width: Math.abs(R - g), height: Math.abs(N - d)},
                    ka = ca = 0;
                W = W ? (W + ta) / W : 1;
                X = X ? (X + fa) / X : 1;
                X = ia.width / w.width;
        ...
        mouseUp: function (J) {
            if (s.getMode() === Q) {
                if (J.mouse_x == g && J.mouse_y == d) return {keep: false, element: c, started: false};
                s.setMode("select");
                return {keep: true, element: c, started: false}
            }
        }
    }
});
(function () {
    ...
    if (!window.requestAnimationFrame) window.requestAnimationFrame = function (b) {
        var l = (new Date).getTime(), s = Math.max(0, 16 - (l - a)), c = window.setTimeout(function () {
            b(l + s)
        }, s);
        a = l + s;
        return c
...
(function (a) {
    ...
    var g = 1E3, d = 5, p = "touchend", w = "touchmove", C = null;
...
var saveAs = saveAs || function (a) {
    if (!(typeof navigator !== "undefined" && /MSIE [1-9]\./.test(navigator.userAgent))) {
        var o = a.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), e = "download" in o,
            b = /Version\/[\d\.]+.*Safari/.test(navigator.userAgent), l = a.webkitRequestFileSystem,
            s = a.requestFileSystem || l || a.mozRequestFileSystem, c = function (L) {
                ...
                if (/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(L.type)) return new Blob(["\ufeff", L], {type: L.type});
                return L
            }, C = function (L, Q, J) {
                J || (L = w(L));
                var H = this;
                J = L.type;
                var U = false, R, N, ca = function () {
                        ...
                        if (N && b && typeof FileReader !==
                            ...
                            if (N) N.location.href = R; else if (a.open(R, "_blank") == undefined && b) a.location.href = R;
                            H.readyState = H.DONE;
                            ca();
                            d(R)
                        }
                        ...
                        s(a.TEMPORARY, g, X(function (ta) {
                            ta.root.getDirectory("saved",
                                W, X(function (ia) {
                                    ...
                                    ia.getFile(Q, {create: false}, X(function (Z) {
                                        Z.remove();
                                        ka()
                                    }), X(function (Z) {
...
if (typeof module !== "undefined" && module.exports) module.exports.saveAs = saveAs; else typeof define !== "undefined" && define !== null && define.amd != null && define([], function () {
    return saveAs
});
